...
data_ = {
   "title":"The Perils of a Rebuild",
   "abstract":"This conversation is about whether or not to rebuild a large, complicated web application that has been in development for 10 years. There is discussion about the pros and cons of rebuilds, the risks involved, and the best way to go about it. Ultimately, the decision will come down to the business needs and the team's ability to execute a successful rebuild.",
   "keypoints":"-The company is considering a rebuild of their large, complicated web application, which has a 10 year old code base.\n-There are concerns about recruiting PHP developers to work on the rebuild, as well as the difficulty of the rebuild itself.\n-It is suggested that the company consider a different language for the rebuild, as well as a cloud-native approach.\n-The strangler pattern is suggested as a potential way to rebuild the application.",
   "struct_text":[
      {
         "UserName":"Dan Richards",
         "Date":"Apr 26",
         "Thread_id":"#5158",
         "content":"I have a client Ive been consulting with for a couple years.They are not asoftware company but they have ended up in the software business by buildingan internal application and then they eventually started selling it to clientsand now they have: A 10 year old code base in PHPMySQL originally built for limited internal usage Some use of Laraval but incomplete 80100 different UI screens perhaps more A fairly complicated backend data aggregator that pulls information from remote sites for near realtime usage A growing customer base in the finance industryThey are considering a rebuild of the application.I hate rebuilds  theyare just always longer harder than you think and filled with peril.Inparticular the ability for the organization to maintain the discipline a rebuild requires for long enough to get it done seems to rarely happen  in mypersonal experience.In addition there is the challenge of how much newdevelopment is done on the existing product while they wait for the new oneetc.In this case though it seems to me that a rebuild may be the onlyreally viable solution.To this end a few questions for this great group of folks: How do you convey and get the business to really understand what it willtake to rebuild a large complicated web application that has 10 years ofcode business logic etc. If you were going to rebuild  basically build a new web application witha decent amount of financial data what languagesdbs would you look to beusing Besides being a bit antiquated I have stressed that recruiting developersfor PHP work may be challenging thoughts on thisIs this worth switchinglanguages for They have to hire new staff to do the rebuild and it seems abit short sighted to only look at PHP developers... In 2022 would you even consider building from a scratch a largecomplicated web app in PHPLaraval Would you prefer a rebuild while flying or build it all new and rolloutthe new one separately approachI like rebuild while flying as it gets newcode into production as soon as it is ready but it definitely comes withcompatibility challenges and ultimately might make the process even longer.Thanks for your thoughts.DanDan Richardsw: 6172494509c: 6173880811e: rodanstradscon.comt: rodandarReplyLikeMore All Messages By This Member Report This MessageFrom: Nikhil Singh nikhiltektorch.com.auBCC MeReply to Author Preview Edit Discard Group ReplyDone Upload AttachmentsCancel AddDone Insert ImagesCancel Add",
         "quoted":"",
         "summary":"It sounds like you think a rebuild may be the only really viable solution for this company's web application. To help convey and get the business to really understand what it will take to rebuild the large, complicated web application, you may want to consider using a different language (such as PHP) and databases. You may also want to consider a rebuild while flying approach to get new code into production as soon as it is ready."
      },
      {
         "UserName":"Sean Goodpasture",
         "Date":"Apr 26",
         "Thread_id":"#5159",
         "content":"A bit tongue in cheek but I agree with your instincts...10 years to build  10 years to rebuildI would pick a more modern stack and language and go far more cloud native.Theres too many options here but I would pick something more accessible likenodejs or java as it will lower the TCO.PHPLaravelNo never.Certainly not in 2022.Having done this the wrong way a bunch the most successful pattern which asyou point out is still fraught with risks Ive used  seen is the stranglerpattern https:www.castsoftware.combloghowtousestranglerpatternformicroservicesmodernization.It takes even longer to do it this way but itchanges the risk profile completely.Sean",
         "quoted":"On Tue Apr 26 2022 at 9:27 AM Dan Richards rodanstradscon.com wrote: I have a client Ive been consulting with for a couple years.They are not a software company but they have ended up in the software business by building an internal application and then they eventually started selling it to clients and now they have: A 10 year old code base in PHPMySQL originally built for limited internal usage Some use of Laraval but incomplete 80100 different UI screens perhaps more A fairly complicated backend data aggregator that pulls information from remote sites for near realtime usage A growing customer base in the finance industry They are considering a rebuild of the application.I hate rebuilds  they are just always longer harder than you think and filled with peril.In particular the ability for the organization to maintain the discipline a rebuild requires for long enough to get it done seems to rarely happen  in my personal experience.In addition there is the challenge of how much new development is done on the existing product while they wait for the new one etc.In this case though it seems to me that a rebuild may be the only really viable solution. To this end a few questions for this great group of folks:  How do you convey and get the business to really understand what it will take to rebuild a large complicated web application that has 10 years of code business logic etc.  If you were going to rebuild  basically build a new web application with a decent amount of financial data what languagesdbs would you look to be using  Besides being a bit antiquated I have stressed that recruiting developers for PHP work may be challenging thoughts on thisIs this worth switching languages for They have to hire new staff to do the rebuild and it seems a bit short sighted to only look at PHP developers...  In 2022 would you even consider building from a scratch a large complicated web app in PHPLaraval  Would you prefer a rebuild while flying or build it all new and rollout the new one separately approachI like rebuild while flying as it gets new code into production as soon as it is ready but it definitely comes with compatibility challenges and ultimately might make the process even longer.Thanks for your thoughts.DanDan Richardsw: 6172494509c: 6173880811e: rodanstradscon.comt: rodandarReplyLikeMore All Messages By This Member Report This MessageFrom: Nikhil Singh nikhiltektorch.com.auBCC MeReply to Author Preview Edit Discard Group ReplyDone Upload AttachmentsCancel AddDone Insert ImagesCancel Add",
         "summary":"I agree with your instincts and would pick a more modern stack and language, but PHP and Laravel are not the best options. The strangler pattern is the most successful way to migrate to microservices, but it takes a long time."
      },
      {
         "UserName":"kkmiller",
         "Date":"Apr 26",
         "Thread_id":"#5160",
         "content":"DanIve seen it done well maybe twice But with a lot more failures including aCTO telling me he could rebuild the entire 15 year old codebase in .NET inthree weekshe did not succeed.If I were in your shoes and starting over Id definitely a choose a moremodern language. I suspect youre right about PHP being difficult to recruitfor now but definitely in the future as well. If theyre selling the productcan you start with a rebuild MVP and then iterate Maybe a smaller version ata smaller price so there are some business incentives that are realized beforethe whole thing is doneI think youre right that running out of momentummoney before its done isprobably the biggest risk.A few options Id see:1 Rebuild parts of itmaybe in a different language maybe not. But start toupdate.2 hire an outside firm to do a rebuild all kinds of dragons there but atleast you dont get distracted internally Maybe3 Spend the next year culling cruft AND THEN reconsider a rewrite. My guessis part of the impetus for a rewrite is a desire to just do better...a ndfixing in place will probably be easier than starting over from scratch.",
         "quoted":"On Tue Apr 26 2022 at 9:27 AM Dan Richards rodanstradscon.com wrote: I have a client Ive been consulting with for a couple years.They are not a software company but they have ended up in the software business by building an internal application and then they eventually started selling it to clients and now they have: A 10 year old code base in PHPMySQL originally built for limited internal usage Some use of Laraval but incomplete 80100 different UI screens perhaps more A fairly complicated backend data aggregator that pulls information from remote sites for near realtime usage A growing customer base in the finance industry They are considering a rebuild of the application.I hate rebuilds  they are just always longer harder than you think and filled with peril.In particular the ability for the organization to maintain the discipline a rebuild requires for long enough to get it done seems to rarely happen  in my personal experience.In addition there is the challenge of how much new development is done on the existing product while they wait for the new one etc.In this case though it seems to me that a rebuild may be the only really viable solution. To this end a few questions for this great group of folks:  How do you convey and get the business to really understand what it will take to rebuild a large complicated web application that has 10 years of code business logic etc.  If you were going to rebuild  basically build a new web application with a decent amount of financial data what languagesdbs would you look to be using  Besides being a bit antiquated I have stressed that recruiting developers for PHP work may be challenging thoughts on thisIs this worth switching languages for They have to hire new staff to do the rebuild and it seems a bit short sighted to only look at PHP developers...  In 2022 would you even consider building from a scratch a large complicated web app in PHPLaraval  Would you prefer a rebuild while flying or build it all new and rollout the new one separately approachI like rebuild while flying as it gets new code into production as soon as it is ready but it definitely comes with compatibility challenges and ultimately might make the process even longer.Thanks for your thoughts.DanDan Richardsw: 6172494509c: 6173880811e: rodanstradscon.comt: rodandarReplyLikeMore All Messages By This Member Report This MessageFrom: Nikhil Singh nikhiltektorch.com.auBCC MeReply to Author Preview Edit Discard Group ReplyDone Upload AttachmentsCancel AddDone Insert ImagesCancel Add",
         "summary":"It is difficult to rebuild a legacy codebase with a limited budget."
      },
      {
         "UserName":"kkmiller",
         "Date":"Apr 26",
         "Thread_id":"#5161",
         "content":"Hit send. Read Seans words. Came back to say.... what Sean said.",
         "quoted":"On Tue Apr 26 2022 at 9:53 AM Sean Goodpasture goofygringmail.com wrote: A bit tongue in cheek but I agree with your instincts... 10 years to build  10 years to rebuild I would pick a more modern stack and language and go far more cloud native.Theres too many options here but I would pick something more accessible like nodejs or java as it will lower the TCO. PHPLaravelNo never.Certainly not in 2022. Having done this the wrong way a bunch the most successful pattern which as you point out is still fraught with risks Ive used  seen is the strangler pattern https:www.castsoftware.combloghowtousestrangler patternformicroservicesmodernization.It takes even longer to do it this way but it changes the risk profile completely. Sean On Tue Apr 26 2022 at 9:27 AM Dan Richards rodanstradscon.com wrote: I have a client Ive been consulting with for a couple years.They are nota software company but they have ended up in the software business bybuilding an internal application and then they eventually started selling itto clients and now they have: A 10 year old code base in PHPMySQL originally built for limitedinternal usage Some use of Laraval but incomplete 80100 different UI screens perhaps more A fairly complicated backend data aggregator that pulls informationfrom remote sites for near realtime usage A growing customer base in the finance industry They are considering a rebuild of the application.I hate rebuilds they are just always longer harder than you think and filled with peril.Inparticular the ability for the organization to maintain the discipline a rebuild requires for long enough to get it done seems to rarely happen  in mypersonal experience.In addition there is the challenge of how much newdevelopment is done on the existing product while they wait for the new oneetc.In this case though it seems to me that a rebuild may be the onlyreally viable solution. To this end a few questions for this great group of folks:  How do you convey and get the business to really understand what itwill take to rebuild a large complicated web application that has 10 yearsof code business logic etc.  If you were going to rebuild  basically build a new web applicationwith a decent amount of financial data what languagesdbs would you look tobe using  Besides being a bit antiquated I have stressed that recruitingdevelopers for PHP work may be challenging thoughts on thisIs this worthswitching languages for They have to hire new staff to do the rebuild and itseems a bit short sighted to only look at PHP developers...  In 2022 would you even consider building from a scratch a largecomplicated web app in PHPLaraval  Would you prefer a rebuild while flying or build it all new androllout the new one separately approachI like rebuild while flying as itgets new code into production as soon as it is ready but it definitely comeswith compatibility challenges and ultimately might make the process evenlonger.Thanks for your thoughts.DanDan Richardsw: 6172494509c: 6173880811e: rodanstradscon.comt: rodandarReplyLikeMore All Messages By This Member Report This MessageFrom: Nikhil Singh nikhiltektorch.com.auBCC MeReply to Author Preview Edit Discard Group ReplyDone Upload AttachmentsCancel AddDone Insert ImagesCancel Add",
      ...
      },
      {
         ...
         "Date":"Apr 26",
         "Thread_id":"#5162",
         "content":"Hi DanBiggest comment would be the Id recommend a strangler pattern rebuildingsubsets of the functionality a piece at a time. Despite the risks around dataintegrity Id also consider just keeping the MySQL db and having both appsreadwrite to it.Id also be super thoughtful about the business risk of messing things up. Atthe most basic make sure you have at a very least daily backups and a testedand working recovery process in the case of data loss.Id also consider replicating production to staging for the current app so youhave a production like environment for testingI might even consider running tests where the new and old staging serversmirror each other and confirm responses to make sure they match  works wellfor legacy code with limited test coverage and specsDefinitely a very big lift try to break it into lots of modest wins.Best WishesPeter",
         "quoted":" On Apr 26 2022 at 11:27 AM Dan Richards rodanstradscon.com wrote: I have a client Ive been consulting with for a couple years.They are not a software company but they have ended up in the software business by building an internal application and then they eventually started selling it to clients and now they have: A 10 year old code base in PHPMySQL originally built for limited internal usage Some use of Laraval but incomplete 80100 different UI screens perhaps more A fairly complicated backend data aggregator that pulls information from remote sites for near realtime usage A growing customer base in the finance industry They are considering a rebuild of the application.I hate rebuilds  they are just always longer harder than you think and filled with peril.In particular the ability for the organization to maintain the discipline a rebuild requires for long enough to get it done seems to rarely happen  in my personal experience.In addition there is the challenge of how much new development is done on the existing product while they wait for the new one etc.In this case though it seems to me that a rebuild may be the only really viable solution. To this end a few questions for this great group of folks:  How do you convey and get the business to really understand what it will take to rebuild a large complicated web application that has 10 years of code business logic etc.  If you were going to rebuild  basically build a new web application with a decent amount of financial data what languagesdbs would you look to be using  Besides being a bit antiquated I have stressed that recruiting developers for PHP work may be challenging thoughts on thisIs this worth switching languages for They have to hire new staff to do the rebuild and it seems a bit short sighted to only look at PHP developers...  In 2022 would you even consider building from a scratch a large complicated web app in PHPLaraval  Would you prefer a rebuild while flying or build it all new and rollout the new one separately approachI like rebuild while flying as it gets new code into production as soon as it is ready but it definitely comes with compatibility challenges and ultimately might make the process even longer.Thanks for your thoughts.DanDan Richardsw: 6172494509c: 6173880811e: rodanstradscon.comt: rodandarReplyLikeMore All Messages By This Member Report This MessageFrom: Nikhil Singh nikhiltektorch.com.auBCC MeReply to Author Preview Edit Discard Group ReplyDone Upload AttachmentsCancel AddDone Insert ImagesCancel Add",
         "summary":"1. Consider rebuilding the new app in subsets to minimize risk.\n2. Consider keeping the MySQL database and having both apps read/write to it.\n3. Make sure you have backups and a tested recovery process in place.\n4. Consider replicating production to staging for the new app.\n5. Run tests to confirm that responses from the new and old apps match."
      },
      {
         "UserName":"Sean Eby",
         "Date":"Apr 26",
         "Thread_id":"#5163",
         "content":"DanALL of these are great questions and no doubt something I am sure numerouspeople in here have faced before myself included. For a rebuild decisionit helps to start with truly understanding what the underlying problems are.Some of which could include but certainly not limited to: Just a really old codebase perhaps on a frame work that is either dying or is deadnolongermaintained. In the PHP world that might be say a CodeIgniter web app. A code base that had very little oversight and less skilled people working on it for years on end leading to a ball of mud as it sometimes might get called with heavy amounts of hardcoding e.g. huge amounts of hardcoded SQL for example little to no reuse catchall classesmodelscontrollers etc. Because of the above potential issues overall maintenance of the app being a huge source of pain is also a struggle. Recruitingtalent can also be a factor particularly if the company is in a growth stage and innovation is important. A COBOL app at a bank for example might be OK in terms of its codebase but lets be honest youre not exactly out recruiting people who want and can work on that to come in and do some more groundbreaking andor new product innovation. Its just not there.  and of course there are numerous other factors besides.For a rebuild to make sense and to even support the business case behind it Ifind it is generally helpful if it also coincides with another effort thatyouthe business want to achieve. For example lets say the UIUX of the appis aging the business and customers know it and there is real desire toinvest in significantly revamping and transforming the UIUX of the productfor the next 57 years of its life. That could be a great project to use as afoundation for why a rebuild might make sense to do in conjunction with it.Besides the issues I mentioned above it also could be the case that theviewpresentation layer of the app and all of the CSS etc. is a total messand thus revamping the UIUX of it does not really make sense with thecurrent codebase thus serious consideration to a rebuild is not out of thequestion and could support your business case behind doing so.On PHP while I myself dont have strong negative opinions of PHP it alsoisnt something greatly excites me. But its not so bad a reputation that Idargue ripping it all out and replacing it with a cool new kid like Elixir orGo or something. From a recruiting standpoint there is plenty of enthusiastictalent in PHP so honestly recruiting is not and has not been a challenge andIve led teams that work predominantly with it for use with backend APIs etc.In 2022 building from scratch while I do think PHPLaravel as a combo is aviable choice there are now so many other great choices as well. But fromscratch in my mind usually refers to starting either a brand new product fromscratch or starting a new company from scratch and thinking thru which techstack you think you would want to marry. SeanG has good points about PHP maybenot being the first choice and I agree. But I will say it is a viable one andif I had a large team that mostly already understood and used PHP I feel itwould be a difficult case to say lets just switch everybody over to somethingelse just cuz.Also as others have now mentioned on this thread the strangler pattern isgood potential path for doing a rebuild. Just know like you already saidits going to be a long path. years at least. Based on what youve shared.Sean Ebysean.ebygmail.com1.847.903.1311",
         "quoted":" On Apr 26 2022 at 9:53 AM Sean Goodpasture goofygringmail.com wrote: A bit tongue in cheek but I agree with your instincts... 10 years to build  10 years to rebuild I would pick a more modern stack and language and go far more cloud native.Theres too many options here but I would pick something more accessible like nodejs or java as it will lower the TCO. PHPLaravelNo never.Certainly not in 2022. Having done this the wrong way a bunch the most successful pattern which as you point out is still fraught with risks Ive used  seen is the strangler pattern https:www.castsoftware.combloghowtousestrangler patternformicroservicesmodernization.It takes even longer to do it this way but it changes the risk profile completely. Sean On Tue Apr 26 2022 at 9:27 AM Dan Richards rodanstradscon.com wrote: I have a client Ive been consulting with for a couple years.They are nota software company but they have ended up in the software business bybuilding an internal application and then they eventually started selling itto clients and now they have: A 10 year old code base in PHPMySQL originally built for limitedinternal usage Some use of Laraval but incomplete 80100 different UI screens perhaps more A fairly complicated backend data aggregator that pulls informationfrom remote sites for near realtime usage A growing customer base in the finance industry They are considering a rebuild of the application.I hate rebuilds they are just always longer harder than you think and filled with peril.Inparticular the ability for the organization to maintain the discipline a rebuild requires for long enough to get it done seems to rarely happen  in mypersonal experience.In addition there is the challenge of how much newdevelopment is done on the existing product while they wait for the new oneetc.In this case though it seems to me that a rebuild may be the onlyreally viable solution. To this end a few questions for this great group of folks:  How do you convey and get the business to really understand what itwill take to rebuild a large complicated web application that has 10 yearsof code business logic etc.  If you were going to rebuild  basically build a new web applicationwith a decent amount of financial data what languagesdbs would you look tobe using  Besides being a bit antiquated I have stressed that recruitingdevelopers for PHP work may be challenging thoughts on thisIs this worthswitching languages for They have to hire new staff to do the rebuild and itseems a bit short sighted to only look at PHP developers...  In 2022 would you even consider building from a scratch a largecomplicated web app in PHPLaraval  Would you prefer a rebuild while flying or build it all new androllout the new one separately approachI like rebuild while flying as itgets new code into production as soon as it is ready but it definitely comeswith compatibility challenges and ultimately might make the process evenlonger.Thanks for your thoughts.DanDan Richardsw: 6172494509c: 6173880811e: rodanstradscon.comt: rodandarReplyLikeMore All Messages By This Member Report This MessageFrom: Nikhil Singh nikhiltektorch.com.auBCC MeReply to Author Preview Edit Discard Group ReplyDone Upload AttachmentsCancel AddDone Insert ImagesCancel Add",
         "summary":"A rebuild may make sense if the underlying problems with the codebase are significant, if there is a desire to significantly revamp the UI/UX, or if the company is in a growth stage and innovation is important. PHP is a viable choice for a rebuild, but there are now many other great choices as well. The strangler pattern is a potential path for doing a rebuild, but it will be a long process."
      },
      {
         "UserName":"david raistrick",
         "Date":"Apr 26",
         "Thread_id":"#5164",
         "content":"On Tue Apr 26 2022 at 11:27 AM Dan Richards rodanstradscon.com wrote:  Besides being a bit antiquated I have stressed that recruiting developers for PHP work may be challenging thoughts on thisIs this worth switching languages for They have to hire new staff to do the rebuild and it seems a bit short sighted to only look at PHP developers...You cant magically remove the old codebase instantly unless it has zerotraffic zero bugs or needs zero feature work theyre going to have tocontinue to support the PHP stack.So switching languages will onlycomplicate the problem.There are plenty of folks still using php  for new and existing projects.  In 2022 would you even consider building from a scratch a large complicated web app in PHPLaravalId start such a consideration with the team in mind.If the current teamare heavily invested in PHP and you show up with a new team writing Java isthe old team going to feel like its time to walkMaybe the team wants totry something new so start with some POC projects based on the teamsinterestIMO language doesnt matter.The team does.If this is a company without a team then obviously its a different startingpoint  but its just as important to consider since you still cant removethe legacy product.  Would you prefer a rebuild while flying or build it all new and rollout the new one separately approachI like rebuild while flying as it gets new code into production as soon as it is ready but it definitely comes with compatibility challenges and ultimately might make the process even longer.Everything comes with compatibility changes and everything makes the processlonger.The other tongueincheek suggestion of it took 10 years to writethe first one itll take 10 years to write the next one isnt wrong.But Its 2022  we need to stop looking at software as something we write once andfinish with.Even packaged applications  which isnt what were talking about here  needmaintenance and rewrites.Software the runs live in front of customersIts never done  so donttry to put done on a roadmap.Done is company folded and the IP gotlost in the shareholder fightA growing product will need changes  to the legacy codebase and the newcodebase.There are very few products that have servers and databases that can do100 rebuild lift and shifts.Those that can generally dont have infra.This sounds like a great time to help the client see the value in rethinkinghow they view their company  theyre in the software business theyreselling software.Theyre a software business.Refocus...david ReplyLikeMore All Messages By This Member Report This MessageFrom: Nikhil Singh nikhiltektorch.com.auBCC MeReply to Author Preview Edit Discard Group ReplyDone Upload AttachmentsCancel AddDone Insert ImagesCancel Add",
         "quoted":"",
         "summary":"The team is more important than the language, and software is never done. A company that is in the software business should focus on selling software, not just on rebuilding their product."
      },
      {
         "UserName":"Sean Goodpasture",
         "Date":"Apr 26",
         "Thread_id":"#5165",
         "content":"DavidYou took the words out of my mouth  the company is actually two  theircurrent core business and a software company.If they want to be trulysuccessful they need to run the software as a product company and drive thatway.Theres lots of positives to spinning it as a separate entitysubsidiary...SeanReplyLikeMore All Messages By This Member Report This MessageFrom: Nikhil Singh nikhiltektorch.com.auBCC MeReply to Author Preview Edit Discard Group ReplyDone Upload AttachmentsCancel AddDone Insert ImagesCancel Add",
         "quoted":"",
         "summary":"The company is actually two companies - their current core business and a software company. If they want to be truly successful they need to run the software as a product company and drive that way."
      },
      {
         "UserName":"Rajiv Menon",
         "Date":"Apr 26",
         "Thread_id":"#5166",
         "content":"DanGood questions. My team at Informulate has a lot of experience 16 yearsconvertingmigrating legacy applications esp. PHPLaravel and .NET. Weveprobably hit every branch on the Surprise Tree and its certainly not trivialto balance current state and future state. To answer your questions:1. How do you convey and get the business to really understand what it will take to rebuild a large complicated web application that has 10 years of code business logic etc. We usually start with some assessments. Code review bug listing known system limitations securityperformance concerns UX and the unnecessary complexity inertia of building in the old system are valid points. At the end of the day its probably more of a business decision than a technical one. So we generally recommend a value proposition mapping exercise to really understand the clients trajectory and building a business case.2. If you were going to rebuild  basically build a new web application with a decent amount of financial data what languagesdbs would you look to be using Others have answered this well enough. Today Id recommend full stack JS3. Besides being a bit antiquated I have stressed that recruiting developers for PHP work may be challenging thoughts on thisIs this worth switching languages for They have to hire new staff to do the rebuild and it seems a bit short sighted to only look at PHP developers... There is a massive installed base of PHP developers. That said Id look at full stack JS.4. In 2022 would you even consider building from a scratch a large complicated web app in PHPLaraval Sure there are business scenarios where that makes sense. But it needs a deeper dive on the business side to understand what problems are being solved. More importantly why is this custom solution that important Is the IP you build worth anything If it can be monetized then its a slam dunk to do. Is it core to their unique competitive advantage If not take another look at packaged apps and do some Product TankG2 searches.5. Would you prefer a rebuild while flying or build it all new and rollout the new one separately approachI like rebuild My preference is to rebuild while flying potentially higher cost and longer timeline but lower business risk. Technically there are creative ways to rebuild while flying. For one client we upgraded feature by feature while keeping the database the same and finally upgraded the database too. In other case we rebuilt from scratch because it needed to be a clean cutover. Internal facing features can be piecemealed externally you want a clean cutover. In some situations it may make sense to upgrade the backend gradually because that is where the biggest risk often is and then do a clean cutover on the front. It depends on the business needs.Happy to jump on a call to discuss more if you need.All the bestRajiv",
         "quoted":"On Tue Apr 26 2022 at 12:16 PM david raistrick keenicantclick.org wrote: On Tue Apr 26 2022 at 11:27 AM Dan Richards rodanstradscon.com wrote:  Besides being a bit antiquated I have stressed that recruitingdevelopers for PHP work may be challenging thoughts on thisIs this worthswitching languages for They have to hire new staff to do the rebuild and itseems a bit short sighted to only look at PHP developers... You cant magically remove the old codebase instantly unless it has zero traffic zero bugs or needs zero feature work theyre going to have to continue to support the PHP stack.So switching languages will only complicate the problem. There are plenty of folks still using php  for new and existing projects.  In 2022 would you even consider building from a scratch a largecomplicated web app in PHPLaraval Id start such a consideration with the team in mind.If the current team are heavily invested in PHP and you show up with a new team writing Java is the old team going to feel like its time to walkMaybe the team wants to try something new so start with some POC projects based on the teams interest IMO language doesnt matter.The team does. If this is a company without a team then obviously its a different starting point  but its just as important to consider since you still cant remove the legacy product.  Would you prefer a rebuild while flying or build it all new androllout the new one separately approachI like rebuild while flying as itgets new code into production as soon as it is ready but it definitely comeswith compatibility challenges and ultimately might make the process evenlonger. Everything comes with compatibility changes and everything makes the process longer.The other tongueincheek suggestion of it took 10 years to write the first one itll take 10 years to write the next one isnt wrong.But  Its 2022  we need to stop looking at software as something we write once and finish with. Even packaged applications  which isnt what were talking about here  need maintenance and rewrites. Software the runs live in front of customersIts never done  so dont try to put done on a roadmap.Done is company folded and the IP got lost in the shareholder fight A growing product will need changes  to the legacy codebase and the new codebase. There are very few products that have servers and databases that can do 100 rebuild lift and shifts.Those that can generally dont have infra. This sounds like a great time to help the client see the value in re thinking how they view their company  theyre in the software business theyre selling software.Theyre a software business.Refocus ...david Informulatehttps:informulate.comemailsignaturesFinalVersion.pngRajiv MenonPhonehttps:informulate.comemailsignaturesglyphicons443earphone3x.png8662222307Mailhttps:informulate.comemailsignaturesglyphicons11envelope3x.pngrajiv.menoninformulate.comWebhttps:informulate.comemailsignaturesglyphicons372global3x.pngwww.Informulate.comhttps:informulate.comemailsignaturesglyphiconssocial31facebook3x.pnghttps:informulate.comemailsignaturesglyphiconssocial32twitter3x.pnghttps:informulate.comemailsignaturesglyphiconssocial18linkedin3x.pngCurious how our software solutions can impact your businessSchedule a discovery consultation. click herehttps:t.sidekickopen90.coms3to5f18dQhb0S7n28bNNhRW7zKg8R1jkhdLW1kL1qZXc5N3s0w0r6bdQkDJFjXWKtLdNJcdH03si7000000001024244pi81d4714f68284414853050ff8849cebbhttps:s3uswest1.amazonaws.comgroupsioattachments238959071056851660AWSAccessKeyIdAKIAJECNKOVMCCU3ATNQExpires1651650871Signature2F5UBCCVwbWiyLpFtOVdK2FqKSNxA3DReplyLikeMore All Messages By This Member Report This MessageFrom: Nikhil Singh nikhiltektorch.com.auBCC MeReply to Author Preview Edit Discard Group ReplyDone Upload AttachmentsCancel AddDone Insert ImagesCancel Add",
         "summary":"1. You need to assess the current state of the application and the client's needs in order to determine whether a rebuild is the best option.\n2. If you do decide to rebuild, consider using full stack JS.\n3. PHP is still a viable option for many applications, so don't rule it out entirely.\n4. It is often best to rebuild while the old application is still live, in order to minimize business risk."
      },
      {
         "UserName":"JasonCole",
         "Date":"Apr 26",
         "Thread_id":"#5167",
         "content":"First this conversation has already given me some great quoteswar storiesthat I need to hear: Ive seen it done well maybe twice But with a lot more failures including a CTO telling me he could rebuild the entire 15 year old codebase in .NET in three weekshe did not succeed. Kendall Miller Software the runs live in front of customersIts never done  so dont try to put done on a roadmap.Done is company folded and the IP got lost in the shareholder fight David RaistrickYeah Im definitely using that second one the next time someone asks me whenwe can stop working on our software.Now a few additional thoughts:10 years to build  10 years to rebuildI know this was kind of a joke and I know from experience that it cansometimes feel true but I want to add one modifier here. Its probably morelike 20 person years to build  15 person years to rebuild. An accidentalSaaS product like this often starts with one engineer futzing around tryingto solve a problem then a team accreting around them over the years likebarnacles on a shipwreck. Now you look at the team and your brain extends theentire team back to the beginning. A lot of that early work was either prettysimple or its been rewritten so its not quite that bad. Theres also a tonof hidden business logic in there though so even if you think you know whatits doing you dont and youll need to rediscover it as you go. How muchhas the team grown in the past few yearsWhats the core valueOver the past ten years the business and the software have evolved so itspossible that you dont need to rebuild the current product but rather tobuild a new product that meets todays needs. Whats that core value Can youcarve that part off offer it as a new version and migrate customers overThen you dont have to try to figure out why it does that thing that Bob wrote9 12 years ago: you can build a new product that does what customers needtoday. This is still a major effort and will probably take a couple of yearsbut if the business has changed significantly then it might be a betteroption. Then youre free to make whatever tech choices you want while puttingthe current product in maintenance mode.Tech choicesIm with David: a productive team is more important than the tech stack butthe ability to build a productive team often depends upon using technologythat productive people want to use. As languages age the dynamics of theteams that work on them change. Mature technologies tend to have more maturepeople working with them as the youngest at heart engineers move on to thelatest toys. As languages age out you generally go through stages where itgets harder to find people who want to work in them fulltime then you canonly find outsourced companies that specialize in them then you have to bringsomeone out of retirement to fix them. PHP is somewhere in the mature but notdying stage right now but if you choose to buildrebuild a large productwith it you should think of it as a fiveyear commitment. Will you be able tobuild the team you want for the next five yearsA storyReed Group wasnt an accidental SaaS company but it definitely wasnt asoftware company when I joined and the early years of the product were drivenby some very opinionated clients. When the product was about five years old agroup of people who had been there in the early years formed a competitor withthe idea that they could take what theyd learned at Reed Group and build anew and better version of our enterprise product in a year. They had a verylight version live in about a year but their customers were unhappy with allthat was missing compared to our fullfeatured version. It took them threeyears to create something that was functionally comparable to the producttheyd left behind and theyve been developing fullspeed ever since to keepup with customer requests. So that was approximately a 60 rebuild cost.Jason ColeCEODa Primus Consultinghttps:s3uswest1.amazonaws.comgroupsioattachments238959071056851670AWSAccessKeyIdAKIAJECNKOVMCCU3ATNQExpires1651650871SignatureIM2BGQwePGsfLMCZknDVIYDZaXoE3D On Apr 26 2022 at 10:23 AM Sean Goodpasture goofygringmail.com wrote: David You took the words out of my mouth  the company is actually two  their current core business and a software company.If they want to be truly successful they need to run the software as a product company and drive that way. Theres lots of positives to spinning it as a separate entitysubsidiary... SeanReplyLikeMore All Messages By This Member Report This MessageFrom: Nikhil Singh nikhiltektorch.com.auBCC MeReply to Author Preview Edit Discard Group ReplyDone Upload AttachmentsCancel AddDone Insert ImagesCancel Add",
         "quoted":"",
         "summary":"1. It can take 10 years to build a software product, and 10 years to rebuild it if it becomes outdated.\n\n2. The team size and tech stack are more important than the actual code.\n\n3. If the business has changed significantly, it may be better to build a new product that meets today's needs rather than rebuild the old one."
      },
      {
         "UserName":"jzapin",
         "Date":"Apr 26",
         "Thread_id":"#5168",
         "content":"Definitely great dialogue here.My only .02 comes from a product perspective.In my experience rebuildingreplatforming usually makes the most sense whenyou truly rethink the value of the application.Im sure there areadvantagescost savings to just rebuild.But it becomes more valuable whenyou improve functionalityusability andor perhaps finding a new marketNotonly does that give the project more opportunity it can also help with moraleof the team itself especially if its the internal team doing it.JZM: 303 5068262linkedin",
         "quoted":"On Tue Apr 26 2022 at 10:39 AM Rajiv Menon rajiv.menoninformulate.netwrote: Dan Good questions. My team at Informulate has a lot of experience 16 years convertingmigrating legacy applications esp. PHPLaravel and .NET. Weve probably hit every branch on the Surprise Tree and its certainly not trivial to balance current state and future state. To answer your questions:1. How do you convey and get the business to really understand what it will take to rebuild a large complicated web application that has 10 years of code business logic etc. We usually start with some assessments. Code review bug listing known system limitations securityperformance concerns UX and the unnecessary complexity inertia of building in the old system are valid points. At the end of the day its probably more of a business decision than a technical one. So we generally recommend a value proposition mapping exercise to really understand the clients trajectory and building a business case.2. If you were going to rebuild  basically build a new web application with a decent amount of financial data what languagesdbs would you look to be using Others have answered this well enough. Today Id recommend full stack JS3. Besides being a bit antiquated I have stressed that recruiting developers for PHP work may be challenging thoughts on thisIs this worth switching languages for They have to hire new staff to do the rebuild and it seems a bit short sighted to only look at PHP developers... There is a massive installed base of PHP developers. That said Id look at full stack JS.4. In 2022 would you even consider building from a scratch a large complicated web app in PHPLaraval Sure there are business scenarios where that makes sense. But it needs a deeper dive on the business side to understand what problems are being solved. More importantly why is this custom solution that important Is the IP you build worth anything If it can be monetized then its a slam dunk to do. Is it core to their unique competitive advantage If not take another look at packaged apps and do some Product TankG2 searches.5. Would you prefer a rebuild while flying or build it all new and rollout the new one separately approachI like rebuild My preference is to rebuild while flying potentially higher cost and longer timeline but lower business risk. Technically there are creative ways to rebuild while flying. For one client we upgraded feature by feature while keeping the database the same and finally upgraded the database too. In other case we rebuilt from scratch because it needed to be a clean cutover. Internal facing features can be piecemealed externally you want a clean cutover. In some situations it may make sense to upgrade the backend gradually because that is where the biggest risk often is and then do a clean cutover on the front. It depends on the business needs. Happy to jump on a call to discuss more if you need. All the best Rajiv On Tue Apr 26 2022 at 12:16 PM david raistrick keenicantclick.org wrote: On Tue Apr 26 2022 at 11:27 AM Dan Richards rodanstradscon.com wrote:  Besides being a bit antiquated I have stressed that recruitingdevelopers for PHP work may be challenging thoughts on thisIs this worthswitching languages for They have to hire new staff to do the rebuild and itseems a bit short sighted to only look at PHP developers... You cant magically remove the old codebase instantly unless it has zerotraffic zero bugs or needs zero feature work theyre going to have tocontinue to support the PHP stack.So switching languages will onlycomplicate the problem. There are plenty of folks still using php  for new and existing projects.  In 2022 would you even consider building from a scratch a largecomplicated web app in PHPLaraval Id start such a consideration with the team in mind.If the current teamare heavily invested in PHP and you show up with a new team writing Java isthe old team going to feel like its time to walkMaybe the team wants totry something new so start with some POC projects based on the teamsinterest IMO language doesnt matter.The team does. If this is a company without a team then obviously its a differentstarting point  but its just as important to consider since you still cantremove the legacy product.  Would you prefer a rebuild while flying or build it all new androllout the new one separately approachI like rebuild while flying as itgets new code into production as soon as it is ready but it definitely comeswith compatibility challenges and ultimately might make the process evenlonger. Everything comes with compatibility changes and everything makes theprocess longer.The other tongueincheek suggestion of it took 10 years towrite the first one itll take 10 years to write the next one isnt wrong.But  Its 2022  we need to stop looking at software as something we write onceand finish with. Even packaged applications  which isnt what were talking about here need maintenance and rewrites. Software the runs live in front of customersIts never done  so donttry to put done on a roadmap.Done is company folded and the IP gotlost in the shareholder fight A growing product will need changes  to the legacy codebase and the newcodebase. There are very few products that have servers and databases that can do100 rebuild lift and shifts.Those that can generally dont have infra. This sounds like a great time to help the client see the value in rethinking how they view their company  theyre in the software businesstheyre selling software.Theyre a software business.Refocus ...david   Informulatehttps:informulate.comemailsignaturesFinal Version.png Rajiv Menon  Phonehttps:informulate.comemailsignaturesglyphicons443earphone3x.png 8662222307  Mailhttps:informulate.comemailsignaturesglyphicons11envelope3x.png rajiv.menoninformulate.com Webhttps:informulate.comemailsignaturesglyphicons372global3x.png www.Informulate.com https:informulate.comemailsignaturesglyphicons social31facebook3x.png https:informulate.comemailsignaturesglyphicons social32twitter3x.png https:informulate.comemailsignaturesglyphiconssocial18linked in3x.png  Curious how our software solutions can impact your business Schedule a discovery consultation. click here  https:t.sidekickopen90.coms3to5f18dQhb0S7n28bNNhRW7zKg8R1jkhdLW1kL1qZXc5N3s0w0r6bdQkDJFjXW KtLdNJcdH03si7000000001024244pi81d4714f68284414853050ff8849cebbhttps:t.sidekickopen87.coms3to5f18dQhb0S7n28c82jcW5Hx50n2zGCvGW40Fv62SXv86W6W100T5v0RzFN5v0w2n1tdBSf20NPl03si8000000001907490pi541710901800499b9813e0941b473a36ReplyLikeMore All Messages By This Member Report This MessageFrom: Nikhil Singh nikhiltektorch.com.auBCC MeReply to Author Preview Edit Discard Group ReplyDone Upload AttachmentsCancel AddDone Insert ImagesCancel Add",
         "summary":"In my experience, rebuilding or replatforming usually makes the most sense when you truly rethink the value of the application. There may be advantages or cost savings to just rebuild, but it becomes more valuable when you improve functionality or usability and/or perhaps finding a new market. Not only does that give the project more opportunity it can also help with morale of the team itself especially if its the internal team doing it."
      },
      {
         "UserName":"Miles Cook",
         "Date":"Apr 26",
         "Thread_id":"#5169",
         "content":"Jason has some brilliant points as well as the person that recommended usingthe strangler pattern. Used once to great effect to effectively rebuildcritical parts of the plane in flight. Oh and the new vode went to a new DDDfolder which could be ported over to the new API we would build.Its been interesting digesting these points. However the tech stack Toolsare only as good as the tools using them Recruitment or finding a goodsoftware house plays more of a part in consideration now more than ever.One thing I havent seen  the why Ian think of a few reasons to rebuild a10 year old tech stack but my worry would be everything goes great flawlessmigration then.... what did we achieve other than a load of spend Would justbe good to understand what isnt working or a problem on the horizon. If itssomething specific that needs to be addressed first.Otherwise no point in my trying to add to some fairly excellent observationsin this thread.",
         "quoted":"On Tue 26 Apr 2022 18:52 Jason Cole jasondaprimus.com wrote: First this conversation has already given me some great quoteswar stories that I need to hear: Ive seen it done well maybe twice But with a lot more failures includinga CTO telling me he could rebuild the entire 15 year old codebase in .NET inthree weekshe did not succeed.  Kendall Miller Software the runs live in front of customersIts never done  so donttry to put done on a roadmap.Done is company folded and the IP gotlost in the shareholder fight  David Raistrick Yeah Im definitely using that second one the next time someone asks me when we can stop working on our software. Now a few additional thoughts :10 years to build  10 years to rebuild I know this was kind of a joke and I know from experience that it can sometimes feel true but I want to add one modifier here. Its probably more like 20 person years to build  15 person years to rebuild. An accidental SaaS product like this often starts with one engineer futzing around trying to solve a problem then a team accreting around them over the years like barnacles on a shipwreck. Now you look at the team and your brain extends the entire team back to the beginning. A lot of that early work was either pretty simple or its been rewritten so its not quite that bad. Theres also a ton of hidden business logic in there though so even if you think you know what its doing you dont and youll need to rediscover it as you go. How much has the team grown in the past few yearsWhats the core value Over the past ten years the business and the software have evolved so its possible that you dont need to rebuild the current product but rather to build a new product that meets todays needs. Whats that core value Can you carve that part off offer it as a new version and migrate customers over Then you dont have to try to figure out why it does that thing that Bob wrote 9 12 years ago: you can build a new product that does what customers need today. This is still a major effort and will probably take a couple of years but if the business has changed significantly then it might be a better option. Then youre free to make whatever tech choices you want while putting the current product in maintenance mode.Tech choices Im with David: a productive team is more important than the tech stack but the ability to build a productive team often depends upon using technology that productive people want to use. As languages age the dynamics of the teams that work on them change. Mature technologies tend to have more mature people working with them as the youngest at heart engineers move on to the latest toys. As languages age out you generally go through stages where it gets harder to find people who want to work in them fulltime then you can only find outsourced companies that specialize in them then you have to bring someone out of retirement to fix them. PHP is somewhere in the mature but not dying stage right now but if you choose to buildrebuild a large product with it you should think of it as a fiveyear commitment. Will you be able to build the team you want for the next five yearsA story Reed Group wasnt an accidental SaaS company but it definitely wasnt a software company when I joined and the early years of the product were driven by some very opinionated clients. When the product was about five years old a group of people who had been there in the early years formed a competitor with the idea that they could take what theyd learned at Reed Group and build a new and better version of our enterprise product in a year. They had a very light version live in about a year but their customers were unhappy with all that was missing compared to our full featured version. It took them three years to create something that was functionally comparable to the product theyd left behind and theyve been developing fullspeed ever since to keep up with customer requests. So that was approximately a 60 rebuild cost. Jason Cole CEO Da Primus Consulting On Apr 26 2022 at 10:23 AM Sean Goodpasture goofygringmail.com wrote: David You took the words out of my mouth  the company is actually two  theircurrent core business and a software company.If they want to be trulysuccessful they need to run the software as a product company and drive thatway. Theres lots of positives to spinning it as a separate entitysubsidiary... Seanhttps:s3uswest1.amazonaws.comgroupsioattachments238959071056851690AWSAccessKeyIdAKIAJECNKOVMCCU3ATNQExpires1651650871Signature2B860xwbWZUhPX3Y2Fila8ucpC2Fak3Dhttps:s3uswest1.amazonaws.comgroupsioattachments238959071056851691AWSAccessKeyIdAKIAJECNKOVMCCU3ATNQExpires1651650871Signature0gYWxn2B7BgRH8ksPnkEEmpsoClA3DReplyLikeMore All Messages By This Member Report This MessageFrom: Nikhil Singh nikhiltektorch.com.auBCC MeReply to Author Preview Edit Discard Group ReplyDone Upload AttachmentsCancel AddDone Insert ImagesCancel Add",
         "summary":"There may be some benefits to rebuilding a 10 year old tech stack, but it is important to consider the costs and risks involved. It is also important to make sure that the new stack will address the specific problems that the old stack had."
      },
      {
         "UserName":"Dan Richards",
         "Date":"Apr 26",
         "Thread_id":"#5170",
         "content":"Man this group rocks sometimes doesnt itGreat feedback from everyone I really appreciate it.I framed this questionbecause my role here is really as a trusted voice to the CEO and he knows Iwont sell him a bunch of bullshit.He is NOT a software person and knowsthat he doesnt know which is why he has me. I mostly stay out of the thedaytoday process so I dont have much vested in the team directly.So inthis case my goal is simply to make sure he knows what kind of stuff hesabout to step in on embarking on a project like this.As you all shared itis much easier said than doneFor those that speculated the rationale driving this is the lure of largerclients with more demands more data etc. which obviously taxes and stressesthe architecture infrastructure etc.Thanks everyoneDanOn 42622 1:13 PM Miles Cook via groups.io wrote: Jason has some brilliant points as well as the person that recommended using the strangler pattern. Used once to great effect to effectively rebuild critical parts of the plane in flight. Oh and the new vode went to a new DDD folder which could be ported over to the new API we would build. Its been interesting digesting these points. However the tech stack Tools are only as good as the tools using them Recruitment or finding a good software house plays more of a part in consideration now more than ever. One thing I havent seen  the why Ian think of a few reasons to rebuild a 10 year old tech stack but my worry would be everything goes great flawless migration then.... what did we achieve other than a load of spend Would just be good to understand what isnt working or a problem on the horizon. If its something specific that needs to be addressed first. Otherwise no point in my trying to add to some fairly excellent observations in this thread. On Tue 26 Apr 2022 18:52 Jason Cole jasondaprimus.com wrote: First this conversation has already given me some great quoteswar storiesthat I need to hear: Ive seen it done well maybe twice But with a lot more failuresincluding a CTO telling me he could rebuild the entire 15 year old codebasein .NET in three weekshe did not succeed.  Kendall Miller Software the runs live in front of customersIts never done  sodont try to put done on a roadmap.Done is company folded and the IPgot lost in the shareholder fight  David Raistrick Yeah Im definitely using that second one the next time someone asks mewhen we can stop working on our software. Now a few additional thoughts : 10 years to build  10 years to rebuild I know this was kind of a joke and I know from experience that it cansometimes feel true but I want to add one modifier here. Its probably morelike 20 person years to build  15 person years to rebuild. An accidentalSaaS product like this often starts with one engineer futzing around tryingto solve a problem then a team accreting around them over the years likebarnacles on a shipwreck. Now you look at the team and your brain extends theentire team back to the beginning. A lot of that early work was either prettysimple or its been rewritten so its not quite that bad. Theres also a tonof hidden business logic in there though so even if you think you know whatits doing you dont and youll need to rediscover it as you go. How muchhas the team grown in the past few years Whats the core value Over the past ten years the business and the software have evolved soits possible that you dont need to rebuild the current product but ratherto build a new product that meets todays needs. Whats that core value Canyou carve that part off offer it as a new version and migrate customersover Then you dont have to try to figure out why it does that thing that Bobwrote 9 12 years ago: you can build a new product that does what customersneed today. This is still a major effort and will probably take a couple ofyears but if the business has changed significantly then it might be a betteroption. Then youre free to make whatever tech choices you want while puttingthe current product in maintenance mode. Tech choices Im with David: a productive team is more important than the tech stackbut the ability to build a productive team often depends upon using technologythat productive people want to use. As languages age the dynamics of theteams that work on them change. Mature technologies tend to have more maturepeople working with them as the youngest at heart engineers move on to thelatest toys. As languages age out you generally go through stages where itgets harder to find people who want to work in them fulltime then you canonly find outsourced companies that specialize in them then you have to bringsomeone out of retirement to fix them. PHP is somewhere in the mature but notdying stage right now but if you choose to buildrebuild a large productwith it you should think of it as a fiveyear commitment. Will you be able tobuild the team you want for the next five years A story Reed Group wasnt an accidental SaaS company but it definitely wasnt asoftware company when I joined and the early years of the product were drivenby some very opinionated clients. When the product was about five years old agroup of people who had been there in the early years formed a competitor withthe idea that they could take what theyd learned at Reed Group and build anew and better version of our enterprise product in a year. They had a verylight version live in about a year but their customers were unhappy with allthat was missing compared to our fullfeatured version. It took them threeyears to create something that was functionally comparable to the producttheyd left behind and theyve been developing fullspeed ever since to keepup with customer requests. So that was approximately a 60 rebuild cost. Jason Cole CEO Da Primus Consulting On Apr 26 2022 at 10:23 AM Sean Goodpasture goofygringmail.comwrote: David You took the words out of my mouth  the company is actually two  theircurrent core business and a software company.If they want to be trulysuccessful they need to run the software as a product company and drive thatway. Theres lots of positives to spinning it as a separateentitysubsidiary... SeanDan Richardsw: 6172494509c: 6173880811e: rodanstradscon.comt: rodandarReplyLikeMore All Messages By This Member Report This MessageFrom: Nikhil Singh nikhiltektorch.com.auBCC MeReply to Author Preview Edit Discard Group ReplyDone Upload AttachmentsCancel AddDone Insert ImagesCancel Add",
         "quoted":"",
         "summary":"The company is considering rebuilding their 10-year-old software product and they want to know if it's worth it. There is no clear answer, but there are some things to consider before making a decision."
      },
      {
         "UserName":"Linda Rolf",
         "Date":"Apr 26",
         "Thread_id":"#5171",
         "content":"Great thread with some excellent insights. The only contributions I can addare these 1. Having been at this for more than 30 years I can 100 support the comments about time to rebuild. I learned early on that developers are an optimistic bunch when it comes to how long something will take to rewrite. One developer stated with absolute certainty that he could rewrite a core OS in 24 hours it was 30 years ago when rolling your own was the norm. We soon after uncovered his substance abuse problem.2. We all know that tech stacks will change over time. I also agree tech is less a factor than the team architecting and building. We rewrote an ASPVBSQL application quite a few years ago with .NET the preferred tool at the time. Even with an excellent team of experienced developers it took far longer than anticipated and left us saddled with .NET .Linda RolfQuest Technology Groupwww.questtechnologygroup.com",
         "quoted":"From: worldwidectolunches.groups.io worldwidectolunches.groups.io OnBehalf Of Miles CookSent: Tuesday April 26 2022 1:14 PMTo: Jason Cole jasondaprimus.comCc: Sean Goodpasture goofygringmail.com worldwideworldwidectolunches.groups.ioSubject: Re: ctolunches rebuildsJason has some brilliant points as well as the person that recommended usingthe strangler pattern. Used once to great effect to effectively rebuildcritical parts of the plane in flight. Oh and the new vode went to a new DDDfolder which could be ported over to the new API we would build.Its been interesting digesting these points. However the tech stack Toolsare only as good as the tools using them Recruitment or finding a goodsoftware house plays more of a part in consideration now more than ever.One thing I havent seen  the why Ian think of a few reasons to rebuild a10 year old tech stack but my worry would be everything goes great flawlessmigration then.... what did we achieve other than a load of spend Would justbe good to understand what isnt working or a problem on the horizon. If itssomething specific that needs to be addressed first.Otherwise no point in my trying to add to some fairly excellent observationsin this thread.On Tue 26 Apr 2022 18:52 Jason Cole jasondaprimus.com wrote: First this conversation has already given me some great quoteswar stories that I need to hear: Ive seen it done well maybe twice But with a lot more failures includinga CTO telling me he could rebuild the entire 15 year old codebase in .NET inthree weekshe did not succeed.  Kendall Miller Software the runs live in front of customersIts never done  so donttry to put done on a roadmap.Done is company folded and the IP gotlost in the shareholder fight  David Raistrick Yeah Im definitely using that second one the next time someone asks me when we can stop working on our software. Now a few additional thoughts :10 years to build  10 years to rebuild I know this was kind of a joke and I know from experience that it can sometimes feel true but I want to add one modifier here. Its probably more like 20 person years to build  15 person years to rebuild. An accidental SaaS product like this often starts with one engineer futzing around trying to solve a problem then a team accreting around them over the years like barnacles on a shipwreck. Now you look at the team and your brain extends the entire team back to the beginning. A lot of that early work was either pretty simple or its been rewritten so its not quite that bad. Theres also a ton of hidden business logic in there though so even if you think you know what its doing you dont and youll need to rediscover it as you go. How much has the team grown in the past few yearsWhats the core value Over the past ten years the business and the software have evolved so its possible that you dont need to rebuild the current product but rather to build a new product that meets todays needs. Whats that core value Can you carve that part off offer it as a new version and migrate customers over Then you dont have to try to figure out why it does that thing that Bob wrote 9 12 years ago: you can build a new product that does what customers need today. This is still a major effort and will probably take a couple of years but if the business has changed significantly then it might be a better option. Then youre free to make whatever tech choices you want while putting the current product in maintenance mode.Tech choices Im with David: a productive team is more important than the tech stack but the ability to build a productive team often depends upon using technology that productive people want to use. As languages age the dynamics of the teams that work on them change. Mature technologies tend to have more mature people working with them as the youngest at heart engineers move on to the latest toys. As languages age out you generally go through stages where it gets harder to find people who want to work in them fulltime then you can only find outsourced companies that specialize in them then you have to bring someone out of retirement to fix them. PHP is somewhere in the mature but not dying stage right now but if you choose to buildrebuild a large product with it you should think of it as a fiveyear commitment. Will you be able to build the team you want for the next five yearsA story Reed Group wasnt an accidental SaaS company but it definitely wasnt a software company when I joined and the early years of the product were driven by some very opinionated clients. When the product was about five years old a group of people who had been there in the early years formed a competitor with the idea that they could take what theyd learned at Reed Group and build a new and better version of our enterprise product in a year. They had a very light version live in about a year but their customers were unhappy with all that was missing compared to our full featured version. It took them three years to create something that was functionally comparable to the product theyd left behind and theyve been developing fullspeed ever since to keep up with customer requests. So that was approximately a 60 rebuild cost. Jason Cole CEO Da Primus Consulting On Apr 26 2022 at 10:23 AM Sean Goodpasture goofygringmail.com wrote: David You took the words out of my mouth  the company is actually two  theircurrent core business and a software company.If they want to be trulysuccessful they need to run the software as a product company and drive thatway. Theres lots of positives to spinning it as a separate entitysubsidiary... SeanReplyLikeMore All Messages By This Member Report This MessageFrom: Nikhil Singh nikhiltektorch.com.auBCC MeReply to Author Preview Edit Discard Group ReplyDone Upload AttachmentsCancel AddDone Insert ImagesCancel Add",
         "summary":"A developer said he could rewrite an OS in a day 30 years ago. He was high.\n\nI'm not entirely sure what this has to do with anything."
      },
      {
         "UserName":"Naveed Ahmed",
         "Date":"Apr 26",
         "Thread_id":"#5172",
         "content":"I agree with you about all your concerns about rebuilds.Just like a car if the app hasnt been diligently wellmaintained it is timeto get rid of it and buy a new one. Unlike a car though its not as simple. Arebuild for a 10 yearold system can take 12 years optimistically.I dont think trying to make the new system work with the old one is aworthwhile exercise. Its the worst of both worlds. You are limited by most ofwhatever was wrong with the old system  then youre not really writing a newsystem youre just updating it.Despite the challenges and risks that you defined with a rewrite you donthave a real choice. You will slowly start bleeding customers. You have to bitethe bullet and start the rewrite.Ive found decent PHP developers very hard to find. The number of PHPdevelopers is not small but the number of qualified ones is.I have rebuilt what was originally a PHP based system. I used Vue for thefrontend and python for the backend but today my recommendations fortechnologies are: ReactVue with Typescript for the frontend. I personally prefer Vue but Irealize react is more popular. Ive found that paradoxically its easier tohire Vue developers they seem to selfselect. Nest JS for the backend. This uses Typescript. NestJS is very highlyopinionated and somewhat hard to get wrong and write spaghetti code like youcan with PHP or Express. Postgres or MySQL for the backend. Both have their pros and cons. Postgrescan get you more powerful queries easier and may be better for your domain.",
         "quoted":"On Tue Apr 26 2022 at 10:27 AM Dan Richards rodanstradscon.com wrote: I have a client Ive been consulting with for a couple years.They are not a software company but they have ended up in the software business by building an internal application and then they eventually started selling it to clients and now they have: A 10 year old code base in PHPMySQL originally built for limited internal usage Some use of Laraval but incomplete 80100 different UI screens perhaps more A fairly complicated backend data aggregator that pulls information from remote sites for near realtime usage A growing customer base in the finance industry They are considering a rebuild of the application.I hate rebuilds  they are just always longer harder than you think and filled with peril.In particular the ability for the organization to maintain the discipline a rebuild requires for long enough to get it done seems to rarely happen  in my personal experience.In addition there is the challenge of how much new development is done on the existing product while they wait for the new one etc.In this case though it seems to me that a rebuild may be the only really viable solution. To this end a few questions for this great group of folks:  How do you convey and get the business to really understand what it will take to rebuild a large complicated web application that has 10 years of code business logic etc.  If you were going to rebuild  basically build a new web application with a decent amount of financial data what languagesdbs would you look to be using  Besides being a bit antiquated I have stressed that recruiting developers for PHP work may be challenging thoughts on thisIs this worth switching languages for They have to hire new staff to do the rebuild and it seems a bit short sighted to only look at PHP developers...  In 2022 would you even consider building from a scratch a large complicated web app in PHPLaraval  Would you prefer a rebuild while flying or build it all new and rollout the new one separately approachI like rebuild while flying as it gets new code into production as soon as it is ready but it definitely comes with compatibility challenges and ultimately might make the process even longer.Thanks for your thoughts.DanDan Richardsw: 6172494509c: 6173880811e: rodanstradscon.comt: rodandarReplyLikeMore All Messages By This Member Report This MessageFrom: Nikhil Singh nikhiltektorch.com.auBCC MeReply to Author Preview Edit Discard Group ReplyDone Upload AttachmentsCancel AddDone Insert ImagesCancel Add",
         "summary":"You should rebuild your system using newer technologies like React, Vue, and Nest JS. This will be a difficult and risky process, but it is necessary in order to keep your system up-to-date and your customers happy."
      },
      {
         "UserName":"Miles Cook",
         "Date":"Apr 26",
         "Thread_id":"#5173",
         "content":"Indeed This thread caught my eye but I should read more... 2 bread streams here: the health of the infrastructure to scale with moreusers and the health of the code to build more features with confidence.What would they place more importance on Its a hard question because oftentruthfully nobody has a crystal ball and wherever the revenue will come fromis the answer.Infrastructure is easy enough. MySql databases can just be made AWSs problemor whoever you want to use. Instancesan be moved from bare metal toscalable groups with sticky sessions or sessions in a dB.Code Id do a review with them: what parts of the system are likely to be indemand for features. Then with an experienced tech doing a sniff test seewhat shape are they in. would it be useful if the business logic resided in anew place If its discrete and seperable to the monolith great. Find theseams make an interface build anew with a new feature.Loads of automatedtests are a must.Im a big fan of risk aversion rebuilding in chunks rather than big bang newbuild all at once. You get a much shorter feedback cycle for one",
         "quoted":"On Tue 26 Apr 2022 19:33 Dan Richards rodanstradscon.com wrote: Man this group rocks sometimes doesnt itGreat feedback from everyone I really appreciate it.I framed this question because my role here is really as a trusted voice to the CEO and he knows I wont sell him a bunch of bullshit.He is NOT a software person and knows that he doesnt know which is why he has me. I mostly stay out of the the daytoday process so I dont have much vested in the team directly.So in this case my goal is simply to make sure he knows what kind of stuff hes about to step in on embarking on a project like this.As you all shared it is much easier said than doneFor those that speculated the rationale driving this is the lure of larger clients with more demands more data etc. which obviously taxes and stresses the architecture infrastructure etc.Thanks everyoneDan On 42622 1:13 PM Miles Cook via groups.io wrote: Jason has some brilliant points as well as the person that recommendedusing the strangler pattern. Used once to great effect to effectively rebuildcritical parts of the plane in flight. Oh and the new vode went to a new DDDfolder which could be ported over to the new API we would build. Its been interesting digesting these points. However the tech stack Toolsare only as good as the tools using them Recruitment or finding a goodsoftware house plays more of a part in consideration now more than ever. One thing I havent seen  the why Ian think of a few reasons to rebuilda 10 year old tech stack but my worry would be everything goes greatflawless migration then.... what did we achieve other than a load of spendWould just be good to understand what isnt working or a problem on thehorizon. If its something specific that needs to be addressed first. Otherwise no point in my trying to add to some fairly excellentobservations in this thread. On Tue 26 Apr 2022 18:52 Jason Cole jasondaprimus.com wrote: First this conversation has already given me some great quoteswarstories that I need to hear: Ive seen it done well maybe twice But with a lot more failuresincluding a CTO telling me he could rebuild the entire 15 year old codebasein .NET in three weekshe did not succeed.  Kendall Miller Software the runs live in front of customersIts never done  sodont try to put done on a roadmap.Done is company folded and the IPgot lost in the shareholder fight  David Raistrick Yeah Im definitely using that second one the next time someone asks mewhen we can stop working on our software. Now a few additional thoughts : 10 years to build  10 years to rebuild I know this was kind of a joke and I know from experience that it cansometimes feel true but I want to add one modifier here. Its probably morelike 20 person years to build  15 person years to rebuild. An accidentalSaaS product like this often starts with one engineer futzing around tryingto solve a problem then a team accreting around them over the years likebarnacles on a shipwreck. Now you look at the team and your brain extends theentire team back to the beginning. A lot of that early work was either prettysimple or its been rewritten so its not quite that bad. Theres also a tonof hidden business logic in there though so even if you think you know whatits doing you dont and youll need to rediscover it as you go. How muchhas the team grown in the past few years Whats the core value Over the past ten years the business and the software have evolved soits possible that you dont need to rebuild the current product but ratherto build a new product that meets todays needs. Whats that core value Canyou carve that part off offer it as a new version and migrate customersover Then you dont have to try to figure out why it does that thing that Bobwrote 9 12 years ago: you can build a new product that does what customersneed today. This is still a major effort and will probably take a couple ofyears but if the business has changed significantly then it might be a betteroption. Then youre free to make whatever tech choices you want while puttingthe current product in maintenance mode. Tech choices Im with David: a productive team is more important than the tech stackbut the ability to build a productive team often depends upon using technologythat productive people want to use. As languages age the dynamics of theteams that work on them change. Mature technologies tend to have more maturepeople working with them as the youngest at heart engineers move on to thelatest toys. As languages age out you generally go through stages where itgets harder to find people who want to work in them fulltime then you canonly find outsourced companies that specialize in them then you have to bringsomeone out of retirement to fix them. PHP is somewhere in the mature but notdying stage right now but if you choose to buildrebuild a large productwith it you should think of it as a fiveyear commitment. Will you be able tobuild the team you want for the next five years A story Reed Group wasnt an accidental SaaS company but it definitely wasnt asoftware company when I joined and the early years of the product were drivenby some very opinionated clients. When the product was about five years old agroup of people who had been there in the early years formed a competitor withthe idea that they could take what theyd learned at Reed Group and build anew and better version of our enterprise product in a year. They had a verylight version live in about a year but their customers were unhappy with allthat was missing compared to our fullfeatured version. It took them threeyears to create something that was functionally comparable to the producttheyd left behind and theyve been developing fullspeed ever since to keepup with customer requests. So that was approximately a 60 rebuild cost. Jason Cole CEO Da Primus Consulting On Apr 26 2022 at 10:23 AM Sean Goodpasture goofygringmail.comwrote: David You took the words out of my mouth  the company is actually two  theircurrent core business and a software company.If they want to be trulysuccessful they need to run the software as a product company and drive thatway. Theres lots of positives to spinning it as a separateentitysubsidiary... SeanDan Richardsw: 6172494509c: 6173880811e: rodanstradscon.comt: rodandarReplyLikeMore All Messages By This Member Report This MessageFrom: Nikhil Singh nikhiltektorch.com.auBCC MeReply to Author Preview Edit Discard Group ReplyDone Upload AttachmentsCancel AddDone Insert ImagesCancel Add",
         "summary":"Infrastructure, code, and revenue are all important factors to consider when deciding which company to work for."
      },
      {
         "UserName":"Jacob Ablowitz",
         "Date":"Apr 26",
         "Thread_id":"#5174",
         "content":"Agree with just about everything stated previously. Two addenda:1 If your CEO decides to proceed with a stranglerpatternstyle slowbutsteady rebuild via microservices Id recommend they focus recruiting uponPHPJS fullstack devs. Given how its virtually impossible to build afront end without JS nowadays they shouldnt be much harder if at all tofind than PHP purists and are relatively unlikely to object to a slow butsteady move to fullstack JS or even better Typescript. JS is also prettyclearly a stack that is likely to survive longterm and even most JS devs aregame to learn TS as it is resumeenhancing to be able to do both.2 The first thing I would do if I were your CEOs CTO would be to build ahighly comprehensive suite of true endtoend tests that thoroughly exerciseall the key customerfacing workflows in the existing tool. Once this iscomplete and functioning it allows you to swap out PHP components for the newmicroservices whatever language theyre built in while still being able toconfirm that none of the core userfacing workflows in the system arebroken. This approach pays repeated dividends every single time theres amajor upgrade to one of your underlying frameworks or thirdparty packagesthat could break stuff  you run your tests and quickly find out whatsbroken. This is one of the first things I did when I took over my current job convincing my CEO that it was worth roughly 6 months of minimal new featuredevelopment bugfixes only to get those E2E tests done: major upgrades arenow an hour or two to a couple days max like when we went straight fromRuby 2.4.2 and Rails 5 to Ruby 2.7.2 and Rails 6.1 in a day for a verycomplicated and multifaceted backend api server monolith.Jacob",
         "quoted":"On Tue Apr 26 2022 at 11:42 AM Linda Rolf lrolfquesttechnologygroup.comwrote: Great thread with some excellent insights. The only contributions I can add are these   1. Having been at this for more than 30 years I can 100 support the comments about time to rebuild. I learned early on that developers are an optimistic bunch when it comes to how long something will take to rewrite. One developer stated with absolute certainty that he could rewrite a core OS in 24 hours it was 30 years ago when rolling your own was the norm. We soon after uncovered his substance abuse problem.  2. We all know that tech stacks will change over time. I also agree tech is less a factor than the team architecting and building. We rewrote an ASPVBSQL application quite a few years ago with .NET the preferred tool at the time. Even with an excellent team of experienced developers it took far longer than anticipated and left us saddled with .NET .   Linda Rolf   Quest Technology Group   www.questtechnologygroup.com  From: worldwidectolunches.groups.io worldwidectolunches.groups.io On Behalf Of Miles CookSent: Tuesday April 26 2022 1:14 PMTo: Jason Cole jasondaprimus.comCc: Sean Goodpasture goofygringmail.com worldwide worldwidectolunches.groups.ioSubject: Re: ctolunches rebuilds   Jason has some brilliant points as well as the person that recommended using the strangler pattern. Used once to great effect to effectively rebuild critical parts of the plane in flight. Oh and the new vode went to a new DDD folder which could be ported over to the new API we would build.   Its been interesting digesting these points. However the tech stack Tools are only as good as the tools using them Recruitment or finding a good software house plays more of a part in consideration now more than ever.   One thing I havent seen  the why Ian think of a few reasons to rebuild a 10 year old tech stack but my worry would be everything goes great flawless migration then.... what did we achieve other than a load of spend Would just be good to understand what isnt working or a problem on the horizon. If its something specific that needs to be addressed first.   Otherwise no point in my trying to add to some fairly excellent observations in this thread.   On Tue 26 Apr 2022 18:52 Jason Cole jasondaprimus.com wrote:   First this conversation has already given me some great quoteswar storiesthat I need to hear:   Ive seen it done well maybe twice But with a lot more failuresincluding a CTO telling me he could rebuild the entire 15 year old codebasein .NET in three weekshe did not succeed.    Kendall Miller   Software the runs live in front of customersIts never done  sodont try to put done on a roadmap.Done is company folded and the IPgot lost in the shareholder fight    David Raistrick   Yeah Im definitely using that second one the next time someone asks mewhen we can stop working on our software.   Now a few additional thoughts :  10 years to build  10 years to rebuild   I know this was kind of a joke and I know from experience that it cansometimes feel true but I want to add one modifier here. Its probably morelike 20 person years to build  15 person years to rebuild. An accidentalSaaS product like this often starts with one engineer futzing around tryingto solve a problem then a team accreting around them over the years likebarnacles on a shipwreck. Now you look at the team and your brain extends theentire team back to the beginning. A lot of that early work was either prettysimple or its been rewritten so its not quite that bad. Theres also a tonof hidden business logic in there though so even if you think you know whatits doing you dont and youll need to rediscover it as you go. How muchhas the team grown in the past few years  Whats the core value   Over the past ten years the business and the software have evolved soits possible that you dont need to rebuild the current product but ratherto build a new product that meets todays needs. Whats that core value Canyou carve that part off offer it as a new version and migrate customersover Then you dont have to try to figure out why it does that thing that Bobwrote 9 12 years ago: you can build a new product that does what customersneed today. This is still a major effort and will probably take a couple ofyears but if the business has changed significantly then it might be a betteroption. Then youre free to make whatever tech choices you want while puttingthe current product in maintenance mode.  Tech choices   Im with David: a productive team is more important than the tech stackbut the ability to build a productive team often depends upon using technologythat productive people want to use. As languages age the dynamics of theteams that work on them change. Mature technologies tend to have more maturepeople working with them as the youngest at heart engineers move on to thelatest toys. As languages age out you generally go through stages where itgets harder to find people who want to work in them fulltime then you canonly find outsourced companies that specialize in them then you have to bringsomeone out of retirement to fix them. PHP is somewhere in the mature but notdying stage right now but if you choose to buildrebuild a large productwith it you should think of it as a fiveyear commitment. Will you be able tobuild the team you want for the next five years  A story   Reed Group wasnt an accidental SaaS company but it definitely wasnt asoftware company when I joined and the early years of the product were drivenby some very opinionated clients. When the product was about five years old agroup of people who had been there in the early years formed a competitor withthe idea that they could take what theyd learned at Reed Group and build anew and better version of our enterprise product in a year. They had a verylight version live in about a year but their customers were unhappy with allthat was missing compared to our fullfeatured version. It took them threeyears to create something that was functionally comparable to the producttheyd left behind and theyve been developing fullspeed ever since to keepup with customer requests. So that was approximately a 60 rebuild cost.   Jason Cole   CEO   Da Primus Consulting     On Apr 26 2022 at 10:23 AM Sean Goodpasture goofygringmail.comwrote:   David  You took the words out of my mouth  the company is actually two  theircurrent core business and a software company.If they want to be trulysuccessful they need to run the software as a product company and drive thatway.   Theres lots of positives to spinning it as a separateentitysubsidiary...   Sean  ReplyLikeMore All Messages By This Member Report This MessageFrom: Nikhil Singh nikhiltektorch.com.auBCC MeReply to Author Preview Edit Discard Group ReplyDone Upload AttachmentsCancel AddDone Insert ImagesCancel Add",
         "summary":"1. Focus on recruiting PHP/JS fullstack devs.\n\n2. Build a comprehensive suite of end-to-end tests."
      },
      {
         "UserName":"Josiah Haswell",
         "Date":"Apr 26",
         "Thread_id":"#5178",
         "content":"I worked on HP OpenView over 10 years ago which was a complex enterprisenetwork monitoring system with thousands of customers.The system had been incontinuous development since the 80s but it had reached the point whereadding any new functionality whatsoever would break existing functionality orsimply take years to implement. HP was faced with a choice: retire the productor rewrite it.They eventually gave the team 1 year this was waterfall mindyou so that was 1 release to release the core SNMP product.We managed itand rewrite paid off and continues to be a leader in the space but hereswhat I learned.1. I absolutely agree with David here. Think about the core challenges thatyour team faces in the existing product: are they related to specifics of yourexisting tech stackIf so consider the most similar tech stack to yoursthat resolves those specific issues.Any new radically different technologystack is likely to slow you down dramatically and result in a huge amount oftechnical debt that may make the product worse. I disagree that PHPLaravelare not modern or effective but there is a high cost to moving away that youwill certainly pay. The language syntax differences may be whatever althoughthey aresubstantial if you change paradigms such as OOfunctional oreventdrivenasync but the entire ecosystem is different and that is nontrivial.2. Microservices are a solution to scalability problems not complexityproblems.Softwaredefined networking is much simpler than physicalnetworking but it is still not an easy skillset to teach a team that does notalready have it its difficult to hire for and absolutely will increase boththe overall complexity of your application and the securityvulnerabilitysurface area of it. If it doesnt solve an existing problem I would thinkcarefully as to whether you need it as microservice architectures are muchharder to build secure and maintain than monolithic architectures.3. The strangler fig pattern is tricky to get right in practice and mightsaddle you with the same structural problems you already have. It might besuitable if the technical debt has been built around a sound core foundationbut I would consider an alternative such as putting the existing applicationinto maintenance mode and rebuilding from a prioritized list of features.4. If you are planning on changing tech stacks try having your seniorengineering team build out some nontrivial strawmen applications to stresstest the platform.Have them implement some microservices.Everything islikely to change from runtime characteristics to build tools to deploymentmodels. Benchmark the time to complete the same task on each platform andextrapolate from that.This will help distinguish the hype from the realitythat you will be working in.HTHJosiahReplyLikeMore All Messages By This Member Report This MessageFrom: Nikhil Singh nikhiltektorch.com.auBCC MeReply to Author Preview Edit Discard Group ReplyDone Upload AttachmentsCancel AddDone Insert ImagesCancel Add",
         "quoted":"",
         "summary":"1. Don't change tech stacks unless you absolutely have to.\n\n2. Microservices are a solution to scalability problems, not complexity problems.\n\n3. The strangler fig pattern is tricky to get right in practice and might saddle you with the same structural problems you already have.\n\n4. If you are planning on changing tech stacks, try having your senior engineering team build out some nontrivial strawmen applications to stress test the platform."
      },
      {
         "UserName":"david raistrick",
         "Date":"Apr 26",
         "Thread_id":"#5179",
         "content":"yesthanks for 2  thats a horse Ive given up on trying to convince people awayfrom mostly.service are great.hundreds of services are a problem thatcreates a large org full of hardtofill roles.sometimes that is what youwant....on 4  take those straw men through the entire lifecycle.build them intoyour daily workflow get them running in production.dont let them stop atthis was fun and it runs great on local  the entire pipeline andlifecycle are important parts to learn during that.",
         "quoted":"On Tue Apr 26 2022 at 3:29 PM Josiah Haswell josiahsunshower.io wrote: I worked on HP OpenView over 10 years ago which was a complex enterprise network monitoring system with thousands of customers.The system had been in continuous development since the 80s but it had reached the point where adding any new functionality whatsoever would break existing functionality or simply take years to implement. HP was faced with a choice: retire the product or rewrite it.They eventually gave the team 1 year this was waterfall mind you so that was 1 release to release the core SNMP product.We managed it and rewrite paid off and continues to be a leader in the space but heres what I learned. 1. I absolutely agree with David here. Think about the core challenges that your team faces in the existing product: are they related to specifics of your existing tech stackIf so consider the most similar tech stack to yours that resolves those specific issues.Any new radically different technology stack is likely to slow you down dramatically and result in a huge amount of technical debt that may make the product worse. I disagree that PHPLaravel are not modern or effective but there is a high cost to moving away that you will certainly pay. The language syntax differences may be whatever although they aresubstantial if you change paradigms such as OOfunctional or eventdrivenasync but the entire ecosystem is different and that is nontrivial. 2. Microservices are a solution to scalability problems not complexity problems.Softwaredefined networking is much simpler than physical networking but it is still not an easy skillset to teach a team that does not already have it its difficult to hire for and absolutely will increase both the overall complexity of your application and the security vulnerability surface area of it. If it doesnt solve an existing problem I would think carefully as to whether you need it as microservice architectures are much harder to build secure and maintain than monolithic architectures. 3. The strangler fig pattern is tricky to get right in practice and might saddle you with the same structural problems you already have. It might be suitable if the technical debt has been built around a sound core foundation but I would consider an alternative such as putting the existing application into maintenance mode and rebuilding from a prioritized list of features. 4. If you are planning on changing tech stacks try having your senior engineering team build out some nontrivial strawmen applications to stress test the platform.Have them implement some microservices.Everything is likely to change from runtime characteristics to build tools to deployment models. Benchmark the time to complete the same task on each platform and extrapolate from that.This will help distinguish the hype from the reality that you will be working in. HTH JosiahReplyLikeMore All Messages By This Member Report This MessageFrom: Nikhil Singh nikhiltektorch.com.auBCC MeReply to Author Preview Edit Discard Group ReplyDone Upload AttachmentsCancel AddDone Insert ImagesCancel Add",
         "summary":"People are arguing about whether microservices are a good idea or not. Some people think that microservices are great, while others think that they are a problem that creates a large org full of hard-to-fill roles."
      },
      {
         "UserName":"Ryan Vice",
         "Date":"Apr 26",
         "Thread_id":"#5182",
         "content":"Im partner in a agency and weve helped with rewrites. Lots of great points.My thoughts:1. The current code is most likely your best documentation of the system and thats the hardest thing about rewriting old systems2. Second hardest is political make sure you can get wins early. We usually try and put an API over the old system and then update UI first as like for like ish. This allows giving stakeholders some new shinny in the short term. Then use things like strangler for BE but Id look for opportunities to refactor and reuse the existing business logic especially for the complex high value pieces3. 1 for full stack JavaScript. It allows you to do more with smaller teams and you can look at doing mobile down the road etc provides additional strategic value to pitch to stakeholders https:vicesoftware.comwpcontentuploads202111ryanvice.png  Ryan ViceCEOVice Software LLC https:cdn2.hubspot.nethubfs53toolsemailsignaturegeneratoriconsphoneicon2x.png1 855 3492248  1 512 7881126 https:cdn2.hubspot.nethubfs53toolsemailsignaturegeneratoriconsemailicon2x.pngryanvicesoftware.com https:cdn2.hubspot.nethubfs53toolsemailsignaturegeneratoriconslinkicon2x.pngwww.vicesoftware.com https:cdn2.hubspot.nethubfs53toolsemailsignaturegeneratoriconsaddressicon2x.png10614 Sans Souci PL Austin TX 78759https:vicesoftware.comwpcontentuploads202201FTCBadgeSquareBlue2022.png https:vicesoftware.comwpcontentuploads202201mvp.png",
         "quoted":"On Apr 26 2022 12:16 PM 0500 M david raistrick keenicantclick.orgwrote: developersReplyLikeMore All Messages By This Member Report This MessageFrom: Nikhil Singh nikhiltektorch.com.auBCC MeReply to Author Preview Edit Discard Group ReplyDone Upload AttachmentsCancel AddDone Insert ImagesCancel AddClose Verify DeleteAre you sure you wish to delete this message from the message archives ofworldwidectolunches.groups.io This cannot be undone.Cancel YesClose Verify RepostAre you sure you wish to repost this messageCancel YesClose Report MessageReasonReport to ModeratorsI think this message isnt appropriate for our group.The Group moderators are responsible for maintaining their community and canaddress these issues. Report to Groups.io SupportI think this violates theTerms of Service. This includes: harm to minors violence or threatsharassment or privacy invasion impersonation or misrepresentation fraud orphishing.Note: Your email address is included with the abuse report.Cancel ReportClose Split TopicThe new topic will begin with this message. Subject of the new topic:Cancel Split Topic1  20 of 34 previous page 1 2 next pagePrevious Topic Next TopicClose LikesClose1. worldwidectolunches.groups.io2. Topics3. rebuildsClose SearchSearch CancelMute This TopicDate Date  21  34 of 34 previous page next pagerebuilds",
         "summary":"1. The current code is most likely your best documentation of the system and that's the hardest thing about rewriting old systems.\n2. Second hardest is political make sure you can get wins early. We usually try and put an API over the old system and then update UI first as like for like ish. This allows giving stakeholders some new shinny in the short term. Then use things like strangler for BE but I'd look for opportunities to refactor and reuse the existing business logic especially for the complex high value pieces.\n3. 1 for full stack JavaScript. It allows you to do more with smaller teams and you can look at doing mobile down the road etc provides additional strategic value to pitch to stakeholders."
      },
      {
         "UserName":"Ghazenfer",
         "Date":"Apr 26",
         "Thread_id":"Apr 26",
         "content":"5184DanIn addition to the problems you mentioned do you also have a problem with thecurrent state of the application or is it quite stable I prefer rebuildwhile flying because you can gradually build instead of building a brand newsystem with tons of new features that may also take a long time to build andthen migrate.In my experience rebuild while flying keeps users engagedand has a better outcome from business perspectives. I would build a newfrontend with a combination of new and existing API maybe proxydelegate insome cases especially for new modules.Ghazenfer MansoorW: 703.444.0505 x 101gmansoortechnologyrivers.comLinkedIn Facebook  Twitter Instagram  MediumTechnology Rivers LLC:Web  LinkedIn  Instagram  Twitter Facebook  YouTube  Reviews  OurWorkhttps:technologyrivers.mxspruce.comapitrackv2DBJruJdPmmmthgJLfgIt92YuMnclZXayl3Zvx2buh2YlRHQy92bz5WYtdmIIybp5ycwV3bydmLzVGaj5Wds9GdjBUZkl2dkxmcvdnIISZkl2dkxmcvdnIscfalse",
         "quoted":"On Tue Apr 26 2022 at 11:27 AM Dan Richardsrodanstradscon.com wrote:  I have a client Ive been consulting with for a couple years.They are not a software company but they have ended up in the software business by building an internal application and then they eventually started selling it to clients and now they have: A 10 year old code base in PHPMySQL originally built for limited internal usage Some use of Laraval but incomplete 80100 different UI screens perhaps more A fairly complicated backend data aggregator that pulls information from remote sites for near realtime usage A growing customer base in the finance industry They are considering a rebuild of the application.I hate rebuilds  they are just always longer harder than you think and filled with peril.In particular the ability for the organization to maintain the discipline a rebuild requires for long enough to get it done seems to rarely happen  in my personal experience.In addition there is the challenge of how much new development is done on the existing product while they wait for the new one etc.In this case though it seems to me that a rebuild may be the only really viable solution. To this end a few questions for this great group of folks:  How do you convey and get the business to really understand what it will take to rebuild a large complicated web application that has 10 years of code business logic etc.  If you were going to rebuild  basically build a new web application with a decent amount of financial data what languagesdbs would you look to be using  Besides being a bit antiquated I have stressed that recruiting developers for PHP work may be challenging thoughts on thisIs this worth switching languages for They have to hire new staff to do the rebuild and it seems a bit short sighted to only look at PHP developers...  In 2022 would you even consider building from a scratch a large complicated web app in PHPLaraval  Would you prefer a rebuild while flying or build it all new and rollout the new one separately approachI like rebuild while flying as it gets new code into production as soon as it is ready but it definitely comes with compatibility challenges and ultimately might make the process even longer.Thanks for your thoughts.DanDan Richardsw: 6172494509c: 6173880811e: rodanstradscon.comt: rodandarReplyLikeMore All Messages By This Member Report This MessageFrom: Nikhil Singh nikhiltektorch.com.auBCC MeReply to Author Preview Edit Discard Group ReplyDone Upload AttachmentsCancel AddDone Insert ImagesCancel Add",
         "summary":"The application is in a stable state, but there are some problems that need to be addressed. A new frontend should be built with a combination of new and existing API."
      },
      {
         "UserName":"David Subar",
         "Date":"Apr 26",
         "Thread_id":"#5185",
         "content":"Rebuild while flying takes longer but a build from scratch will always takelonger than expected have unexpected bugs and will cause dissatisfaction ofthe executives who feel like they keep waiting and waiting to get back towhere they were before. It is politically fraught. In addition since themarket changes the requirements for the new system will change as you arebuilding it assuming you are going for parity so your ability to show valuewill be even further delayed.There are some situations where you should build from scratch but I wouldgenerally suggest the strangle pattern as stated earlier by others.Cornerstone OnDemand did a good job executing through this and I had the goodfortune to interview one of their exec about it. If you want to listen it ishere https:www.interna.compostbottlenecksteamtopologiesThe first 15 minutes address the monolith to microservices transformation andthe next 45 take about org changes to facilitate the new architecture. Bothare interesting.HTHDavidhttps:lh6.googleusercontent.comBbEV4BXcJ4XXYifPSzoTJtFfXwaZmPl3sd8Ly6gV71vdhB1J72oUVHIWbRJfhaYQavdeWdgbvbt1RSSgyStBQVZc39JVAbHVX5wzryRv4RAXFnmhZeCaSXgcoASIHdY8DV9U1David SubarFounder and Managing PartnerWebsite  LinkedIn  TwitterOn Tue Apr 26 2022 at 1:39 PM Ghazenfer Mansoorgmansoortechnologyrivers.com wrote: Dan In addition to the problems you mentioned do you also have a problem with the current state of the application or is it quite stable I prefer re build while flying because you can gradually build instead of building a brand new system with tons of new features that may also take a long time to build and then migrate.In my experience rebuild while flying keeps users engaged and has a better outcome from business perspectives. I would build a new frontend with a combination of new and existing API maybe proxydelegate in some cases especially for new modules. Ghazenfer Mansoor W: 703.444.0505 x 101 gmansoortechnologyrivers.com LinkedIn Facebook  Twitter Instagram  Medium Technology Rivers LLC: Web  LinkedIn  Instagram  Twitter Facebook  YouTube  Reviews  Our Work https:technologyrivers.mxspruce.comapitrackv2DBJruJdPmmmthgJLfgIt92YuMnclZXayl3Zvx2buh2YlRHQy92bz5WYtdmIIybp5ycwV3bydmLzVGaj5Wds9GdjBUZkl2dkxmcvdnIISZkl2dkxmcvdnIscfalse On Tue Apr 26 2022 at 11:27 AM Dan Richardsrodanstradscon.com wrote:  I have a client Ive been consulting with for a couple years.They are nota software company but they have ended up in the software business bybuilding an internal application and then they eventually started selling itto clients and now they have: A 10 year old code base in PHPMySQL originally built for limitedinternal usage Some use of Laraval but incomplete 80100 different UI screens perhaps more A fairly complicated backend data aggregator that pulls informationfrom remote sites for near realtime usage A growing customer base in the finance industry They are considering a rebuild of the application.I hate rebuilds they are just always longer harder than you think and filled with peril.Inparticular the ability for the organization to maintain the discipline a rebuild requires for long enough to get it done seems to rarely happen  in mypersonal experience.In addition there is the challenge of how much newdevelopment is done on the existing product while they wait for the new oneetc.In this case though it seems to me that a rebuild may be the onlyreally viable solution. To this end a few questions for this great group of folks:  How do you convey and get the business to really understand what itwill take to rebuild a large complicated web application that has 10 yearsof code business logic etc.  If you were going to rebuild  basically build a new web applicationwith a decent amount of financial data what languagesdbs would you look tobe using  Besides being a bit antiquated I have stressed that recruitingdevelopers for PHP work may be challenging thoughts on thisIs this worthswitching languages for They have to hire new staff to do the rebuild and itseems a bit short sighted to only look at PHP developers...  In 2022 would you even consider building from a scratch a largecomplicated web app in PHPLaraval  Would you prefer a rebuild while flying or build it all new androllout the new one separately approachI like rebuild while flying as itgets new code into production as soon as it is ready but it definitely comeswith compatibility challenges and ultimately might make the process evenlonger.Thanks for your thoughts.DanDan Richardsw: 6172494509c: 6173880811e: rodanstradscon.comt: rodandar ReplyLikeMore All Messages By This Member Report This MessageFrom: Nikhil Singh nikhiltektorch.com.auBCC MeReply to Author Preview Edit Discard Group ReplyDone Upload AttachmentsCancel AddDone Insert ImagesCancel Add",
         "quoted":"",
         "summary":"Rebuild while flying keeps users engaged and has a better outcome from business perspectives."
      },
      {
         "UserName":"andy.pai",
         "Date":"Apr 26",
         "Thread_id":"#5186",
         "content":"DanI just wanted to add a comment on staffing a project like this. Ive only everseen this go well when you start it off with a small team of maybe 13 veryexperienced engineers and let them be focused on the work. Treat it like astartup would and let a small very talented team do one thing and do it welland youll be surprised how fast they can move.Trying to migrate a lot of features to a new architecture with lessexperienced folks or trying to do this alongside of maintainingextending theexisting product or trying to tackle the early stages of a large green fieldproject with a big team are all super hard and the project will take manytimes longer than you think.Hopefully the data aggregation piece you mentioned is separate enough that youcan set that aside and only address the web app. If not maybe splitting thatout would be a good first step.Andy",
         "quoted":"On Tue Apr 26 2022 at 9:27 AM Dan Richards rodanstradscon.com wrote: I have a client Ive been consulting with for a couple years.They are not a software company but they have ended up in the software business by building an internal application and then they eventually started selling it to clients and now they have: A 10 year old code base in PHPMySQL originally built for limited internal usage Some use of Laraval but incomplete 80100 different UI screens perhaps more A fairly complicated backend data aggregator that pulls information from remote sites for near realtime usage A growing customer base in the finance industry They are considering a rebuild of the application.I hate rebuilds  they are just always longer harder than you think and filled with peril.In particular the ability for the organization to maintain the discipline a rebuild requires for long enough to get it done seems to rarely happen  in my personal experience.In addition there is the challenge of how much new development is done on the existing product while they wait for the new one etc.In this case though it seems to me that a rebuild may be the only really viable solution. To this end a few questions for this great group of folks:  How do you convey and get the business to really understand what it will take to rebuild a large complicated web application that has 10 years of code business logic etc.  If you were going to rebuild  basically build a new web application with a decent amount of financial data what languagesdbs would you look to be using  Besides being a bit antiquated I have stressed that recruiting developers for PHP work may be challenging thoughts on thisIs this worth switching languages for They have to hire new staff to do the rebuild and it seems a bit short sighted to only look at PHP developers...  In 2022 would you even consider building from a scratch a large complicated web app in PHPLaraval  Would you prefer a rebuild while flying or build it all new and rollout the new one separately approachI like rebuild while flying as it gets new code into production as soon as it is ready but it definitely comes with compatibility challenges and ultimately might make the process even longer.Thanks for your thoughts.DanDan Richardsw: 6172494509c: 6173880811e: rodanstradscon.comt: rodandarReplyLikeMore All Messages By This Member Report This MessageFrom: Nikhil Singh nikhiltektorch.com.auBCC MeReply to Author Preview Edit Discard Group ReplyDone Upload AttachmentsCancel AddDone Insert ImagesCancel Add",
         "summary":"When working on a big project like this, set up a small team of very experienced engineers and let them work on it."
      },
      {
         "UserName":"Dominic",
         "Date":"Apr 28",
         "Thread_id":"Apr 28",
         "content":"5195The only dissentingandbiased opinion I have is that PHPLaravel can be asolid choice. Everyone myself included loves Next.js and Nuxt.js andtheres a place for ReactReduxetc. for true web applications but they allneed deep customizations.The modern stack we recommend and includes robust applications forEnterpriseMidMarketStartup engagements is called TALLstack TailwindAlpine Laravel Livewire. Taylor and his team has done a solid job with Novaadmin panel and Filament components and theres a lot of polished workdone. The alternative would be VILT stack which is Vue  Intertia  Laravel Tailwind but I think its a little too new.Ive never been impressed with Django but Atom and Flask are solid. Ruby onRails is just so fun to configure and manage over 10 years. .NET haspowerful but you have to enjoy drinking KoolAid.PHP developers are now 20 years older more mature aware of patterns etc.Its like seeing Nirvana or Green Day play at Carnegie  youre going to get amore solid experience than the o.g. days. but it still retains the punk rockroots.BestDom https:dtsignaturegen.netlify.appimgdtlogofull.568645e1.pngDom TancrediCoFounderMAKE. PROGRESS.Office: 773.377.5585  Mobile: 718.431.5137domdomandtom.com domandtom.comSent via Superhuman",
         "quoted":"On Tue Apr 26 2022 at 6:35 PM andy.pai andy.paigmail.com wrote: Dan I just wanted to add a comment on staffing a project like this. Ive only ever seen this go well when you start it off with a small team of maybe 13 very experienced engineers and let them be focused on the work. Treat it like a startup would and let a small very talented team do one thing and do it well and youll be surprised how fast they can move. Trying to migrate a lot of features to a new architecture with less experienced folks or trying to do this alongside of maintainingextending the existing product or trying to tackle the early stages of a large green field project with a big team are all super hard and the project will take many times longer than you think. Hopefully the data aggregation piece you mentioned is separate enough that you can set that aside and only address the web app. If not maybe splitting that out would be a good first step. Andy On Tue Apr 26 2022 at 9:27 AM Dan Richards rodanstradscon.com wrote: I have a client Ive been consulting with for a couple years.They are nota software company but they have ended up in the software business bybuilding an internal application and then they eventually started selling itto clients and now they have: A 10 year old code base in PHPMySQL originally built for limitedinternal usage Some use of Laraval but incomplete 80100 different UI screens perhaps more A fairly complicated backend data aggregator that pulls informationfrom remote sites for near realtime usage A growing customer base in the finance industry They are considering a rebuild of the application.I hate rebuilds they are just always longer harder than you think and filled with peril.Inparticular the ability for the organization to maintain the discipline a rebuild requires for long enough to get it done seems to rarely happen  in mypersonal experience.In addition there is the challenge of how much newdevelopment is done on the existing product while they wait for the new oneetc.In this case though it seems to me that a rebuild may be the onlyreally viable solution. To this end a few questions for this great group of folks:  How do you convey and get the business to really understand what itwill take to rebuild a large complicated web application that has 10 yearsof code business logic etc.  If you were going to rebuild  basically build a new web applicationwith a decent amount of financial data what languagesdbs would you look tobe using  Besides being a bit antiquated I have stressed that recruitingdevelopers for PHP work may be challenging thoughts on thisIs this worthswitching languages for They have to hire new staff to do the rebuild and itseems a bit short sighted to only look at PHP developers...  In 2022 would you even consider building from a scratch a largecomplicated web app in PHPLaraval  Would you prefer a rebuild while flying or build it all new androllout the new one separately approachI like rebuild while flying as itgets new code into production as soon as it is ready but it definitely comeswith compatibility challenges and ultimately might make the process evenlonger.Thanks for your thoughts.DanDan Richardsw: 6172494509c: 6173880811e: rodanstradscon.comt: rodandarReplyLikeMore All Messages By This Member Report This MessageFrom: Nikhil Singh nikhiltektorch.com.auBCC MeReply to Author Preview Edit Discard Group ReplyDone Upload AttachmentsCancel AddDone Insert ImagesCancel Add",
         "summary":"PHP developers are now more experienced and aware of patterns and best practices, making it a more solid choice for web development. However, some newer frameworks like Laravel and TALLstack are also worth considering."
      },
      {
         "UserName":"Ryan Vice",
         "Date":"Apr 28",
         "Thread_id":"#5197",
         "content":"Adding onto Dans point. I havent done it but Ive been told from respectedCTOs that this is a great use case for GraphQL. If you put a GraphQL API overthe old API then you can provide a lot of flexibility to the new UI. photographhttps:i.ibb.con7jqV86ryanviceheadshot.jpg  RyanViceCEO  Vice Software LLCm: 5127881126p: 1 855 3492248e: ryanvicesoftware.com10614 Sans Souci PLAustin TX 78759www.vicesoftware.comfacebook iconhttps:codetwocdn.azureedge.netimagesmailsignaturesgeneratorsimplephotofb.png twittericonhttps:codetwocdn.azureedge.netimagesmailsignaturesgeneratorsimplephotott.png youtubeiconhttps:codetwocdn.azureedge.netimagesmailsignaturesgeneratorsimplephotoyt.png linkediniconhttps:codetwocdn.azureedge.netimagesmailsignaturesgeneratorsimplephotoln.png",
         "quoted":"On Apr 26 2022 3:39 PM 0500 Ghazenfer Mansoorgmansoortechnologyrivers.com wrote: Dan In addition to the problems you mentioned do you also have a problem with the current state of the application or is it quite stable I prefer re build while flying because you can gradually build instead of building a brand new system with tons of new features that may also take a long time to build and then migrate.In my experience rebuild while flying keeps users engaged and has a better outcome from business perspectives. I would build a new frontend with a combination of new and existing API maybe proxydelegate in some cases especially for new modules. Ghazenfer Mansoor W: 703.444.0505 x 101gmansoortechnologyrivers.comLinkedIn Facebook  Twitter Instagram  MediumTechnology Rivers LLC: Web  LinkedIn  Instagram  Twitter Facebook  YouTube  Reviews  Our Work  https:technologyrivers.mxspruce.comapitrackv2DBJruJdPmmmthgJLfgIt92YuMnclZXayl3Zvx2buh2YlRHQy92bz5WYtdmIIybp5ycwV3bydmLzVGaj5Wds9GdjBUZkl2dkxmcvdnIISZkl2dkxmcvdnIscfalse On Tue Apr 26 2022 at 11:27 AM Dan Richards rodanstradscon.com wrote:  I have a client Ive been consulting with for a couple years.They are nota software company but they have ended up in the software business bybuilding an internal application and then they eventually started selling itto clients and now they have: A 10 year old code base in PHPMySQL originally built for limitedinternal usage Some use of Laraval but incomplete 80100 different UI screens perhaps more A fairly complicated backend data aggregator that pulls informationfrom remote sites for near realtime usage A growing customer base in the finance industry They are considering a rebuild of the application.I hate rebuilds they are just always longer harder than you think and filled with peril.Inparticular the ability for the organization to maintain the discipline a rebuild requires for long enough to get it done seems to rarely happen  in mypersonal experience.In addition there is the challenge of how much newdevelopment is done on the existing product while they wait for the new oneetc.In this case though it seems to me that a rebuild may be the onlyreally viable solution. To this end a few questions for this great group of folks:  How do you convey and get the business to really understand what itwill take to rebuild a large complicated web application that has 10 yearsof code business logic etc.  If you were going to rebuild  basically build a new web applicationwith a decent amount of financial data what languagesdbs would you look tobe using  Besides being a bit antiquated I have stressed that recruitingdevelopers for PHP work may be challenging thoughts on thisIs this worthswitching languages for They have to hire new staff to do the rebuild and itseems a bit short sighted to only look at PHP developers...  In 2022 would you even consider building from a scratch a largecomplicated web app in PHPLaraval  Would you prefer a rebuild while flying or build it all new androllout the new one separately approachI like rebuild while flying as itgets new code into production as soon as it is ready but it definitely comeswith compatibility challenges and ultimately might make the process evenlonger.Thanks for your thoughts.DanDan Richardsw: 6172494509c: 6173880811e: rodanstradscon.comt: rodandar ReplyLikeMore All Messages By This Member Report This MessageFrom: Nikhil Singh nikhiltektorch.com.auBCC MeReply to Author Preview Edit Discard Group ReplyDone Upload AttachmentsCancel AddDone Insert ImagesCancel Add",
         "summary":"If you put a GraphQL API over the old API, you can provide a lot of flexibility to the new UI."
      },
      {
         "UserName":"Josiah Haswell",
         "Date":"Apr 28",
         "Thread_id":"#5198",
         "content":"Id like to second Dominics point here as I dont think I was clear before.Boring tech is awesome and most surprises in software are unpleasant ones.I love JavaSpringVaadin which you might considerIve nevereverworked in a more productive UI environment than Vaadin and the only surpriseIve basically ever encountered is how rich and robust they are.That said Ithink PHPLaravel are a rocksolid choice for the same reasonsReplyLikeMore All Messages By This Member Report This MessageFrom: Nikhil Singh nikhiltektorch.com.auBCC MeReply to Author Preview Edit Discard Group ReplyDone Upload AttachmentsCancel AddDone Insert ImagesCancel Add",
         "quoted":"",
         "summary":"Laravel is an awesome PHP framework and you should use it if you can."
      },
      {
         "UserName":"Erik Brandsberg",
         "Date":"Apr 28",
         "Thread_id":"#5199",
         "content":"Im going to add my .02 in.I like Java myself and use it for our productwhich looks at the modernization issue from a different approach.We providea database proxy that provides a variety of services between often legacy appsand the db including caching connection management with multiplexingvisibility etc.Often customers can use us to reduce the load on the DB andimprove response time to older apps without having to rebuild them.Thevisibility aspects are useful as well as it presents wait time differentlythan many other tools and helps you spot the areas really impactingperformance.Rewrites arent always the answer...",
         "quoted":"On Thu Apr 28 2022 at 2:01 PM Josiah Haswell josiahsunshower.io wrote: Id like to second Dominics point here as I dont think I was clear before. Boring tech is awesome and most surprises in software are unpleasant ones. I love JavaSpringVaadin which you might considerIve never ever worked in a more productive UI environment than Vaadin and the only surprise Ive basically ever encountered is how rich and robust they are. That said I think PHPLaravel are a rocksolid choice for the same reasonsReplyLikeMore All Messages By This Member Report This MessageFrom: Nikhil Singh nikhiltektorch.com.auBCC MeReply to Author Preview Edit Discard Group ReplyDone Upload AttachmentsCancel AddDone Insert ImagesCancel Add",
         "summary":"If you have a legacy application that is written in Java, it is often possible to improve performance without rewriting the entire application. One way to do this is to use a database proxy that provides caching and connection management. This can help to reduce the load on the database and improve response time."
      },
      {
         "UserName":"james Ford",
         "Date":"Apr 28",
         "Thread_id":"#5200",
         "content":"Been a lot of great ideas patterns and suggestions.In the end I think its always the same. Find the seams encapsulate theugliness isolate it behind an interface and evolve the service behind theinterface.James FordFounderPareidolia LLChttps:www.pareidolia.rocksWhere Vision meets Reality",
         "quoted":" On Apr 28 2022 at 2:54 PM Erik Brandsberg erikheimdalldata.com wrote:  Im going to add my .02 in.I like Java myself and use it for our product which looks at the modernization issue from a different approach. We provide a database proxy that provides a variety of services between often legacy apps and the db including caching connection management with multiplexing visibility etc.Often customers can use us to reduce the load on the DB and improve response time to older apps without having to rebuild them.The visibility aspects are useful as well as it presents wait time differently than many other tools and helps you spot the areas really impacting performance.Rewrites arent always the answer... On Thu Apr 28 2022 at 2:01 PM Josiah Haswell josiahsunshower.io wrote: Id like to second Dominics point here as I dont think I was clearbefore.Boring tech is awesome and most surprises in software areunpleasant ones. I love JavaSpringVaadin which you might considerIveneverever worked in a more productive UI environment than Vaadin andthe only surprise Ive basically ever encountered is how rich and robust theyare.That said I think PHPLaravel are a rocksolid choice for the samereasonsReplyLikeMore All Messages By This Member Report This MessageFrom: Nikhil Singh nikhiltektorch.com.auBCC MeReply to Author Preview Edit Discard Group ReplyDone Upload AttachmentsCancel AddDone Insert ImagesCancel Add",
         "summary":"In software development, it is often necessary to change the way a service works in order to improve it. However, this can be difficult to do without breaking the existing interface that other services rely on. One way to solve this problem is to use an adapter pattern, which allows the service to be changed without breaking the interface."
      },
      {
         "UserName":"james Ford",
         "Date":"Apr 28",
         "Thread_id":"#5201",
         "content":"At ADP we had a cobol mainframe payroll processing Engine that was 40 yearsold. Full rewrites of old systems bring along obsoleted functionality unlessyou can get the telemetry to know what is used and what is no longer needed.IJames FordFounderPareidolia LLChttps:www.pareidolia.rocksWhere Vision meets Reality",
         "quoted":" On Apr 28 2022 at 5:19 PM james Ford via groups.io james.fordpareidolia.rocksgroups.io wrote: Been a lot of great ideas patterns and suggestions. In the end I think its always the same. Find the seams encapsulate the ugliness isolate it behind an interface and evolve the service behind the interface. James Ford Founder Pareidolia LLChttps:www.pareidolia.rocksWhere Vision meets Reality On Apr 28 2022 at 2:54 PM Erik Brandsberg erikheimdalldata.com wrote:  Im going to add my .02 in.I like Java myself and use it for ourproduct which looks at the modernization issue from a different approach.Weprovide a database proxy that provides a variety of services between oftenlegacy apps and the db including caching connection management withmultiplexing visibility etc.Often customers can use us to reduce theload on the DB and improve response time to older apps without having torebuild them.The visibility aspects are useful as well as it presents waittime differently than many other tools and helps you spot the areas reallyimpacting performance.Rewrites arent always the answer... On Thu Apr 28 2022 at 2:01 PM Josiah Haswell josiahsunshower.io wrote: Id like to second Dominics point here as I dont think I was clearbefore.Boring tech is awesome and most surprises in software areunpleasant ones. I love JavaSpringVaadin which you might considerIveneverever worked in a more productive UI environment than Vaadin andthe only surprise Ive basically ever encountered is how rich and robust theyare.That said I think PHPLaravel are a rocksolid choice for the samereasonsReplyLikeMore All Messages By This Member Report This MessageFrom: Nikhil Singh nikhiltektorch.com.auBCC MeReply to Author Preview Edit Discard Group ReplyDone Upload AttachmentsCancel AddDone Insert ImagesCancel Add",
         "summary":"If you want to keep the functionality of an old system, you need to keep\n\nthe telemetry."
      },
      {
         "UserName":"kkmiller",
         "Date":"Apr 28",
         "Thread_id":"#5202",
         "content":"Rust or Bust in God We Trust. Refactor Rebuild Rebase.We can almost justify any expense we make.",
         "quoted":"On Thu Apr 28 2022 at 3:19 PM james Ford james.fordpareidolia.rockswrote: Been a lot of great ideas patterns and suggestions. In the end I think its always the same. Find the seams encapsulate the ugliness isolate it behind an interface and evolve the service behind the interface. James Ford Founder Pareidolia LLChttps:www.pareidolia.rocksWhere Vision meets Reality On Apr 28 2022 at 2:54 PM Erik Brandsberg erikheimdalldata.com wrote:  Im going to add my .02 in.I like Java myself and use it for ourproduct which looks at the modernization issue from a different approach.Weprovide a database proxy that provides a variety of services between oftenlegacy apps and the db including caching connection management withmultiplexing visibility etc.Often customers can use us to reduce theload on the DB and improve response time to older apps without having torebuild them.The visibility aspects are useful as well as it presents waittime differently than many other tools and helps you spot the areas reallyimpacting performance.Rewrites arent always the answer... On Thu Apr 28 2022 at 2:01 PM Josiah Haswell josiahsunshower.io wrote: Id like to second Dominics point here as I dont think I was clearbefore.Boring tech is awesome and most surprises in software areunpleasant ones. I love JavaSpringVaadin which you might considerIveneverever worked in a more productive UI environment than Vaadin andthe only surprise Ive basically ever encountered is how rich and robust theyare.That said I think PHPLaravel are a rocksolid choice for the samereasonsReplyLikeMore All Messages By This Member Report This MessageFrom: Nikhil Singh nikhiltektorch.com.auBCC MeReply to Author Preview Edit Discard Group ReplyDone Upload AttachmentsCancel AddDone Insert ImagesCancel Add",
         "summary":"Content Too Short To Summarize..."
      },
      {
         "UserName":"Kris Ciccarelli",
         "Date":"Apr 28",
         "Thread_id":"#5203",
         "content":"Currently in the middle of a from scratch rewrite started by previousleadership which was already promised before I even started.Scary enough totackle a greenfield rewrite but when you dont get to pick the teamtimeline plan technology its even more funMy friend Dan wrote a great blogpost about this that I still read whenever Iget involved in one of these projects. Definitely worth a readhttps:www.onstartups.comtabid3339bid97052HowToSurviveaGroundUpRewriteWithoutLosingYourSanity.aspxKris",
         "quoted":" On Apr 28 2022 at 2:54 PM Erik Brandsberg erikheimdalldata.com wrote:  Im going to add my .02 in.I like Java myself and use it for our product which looks at the modernization issue from a different approach. We provide a database proxy that provides a variety of services between often legacy apps and the db including caching connection management with multiplexing visibility etc.Often customers can use us to reduce the load on the DB and improve response time to older apps without having to rebuild them.The visibility aspects are useful as well as it presents wait time differently than many other tools and helps you spot the areas really impacting performance.Rewrites arent always the answer... On Thu Apr 28 2022 at 2:01 PM Josiah Haswell josiahsunshower.io wrote: Id like to second Dominics point here as I dont think I was clearbefore.Boring tech is awesome and most surprises in software areunpleasant ones. I love JavaSpringVaadin which you might considerIveneverever worked in a more productive UI environment than Vaadin andthe only surprise Ive basically ever encountered is how rich and robust theyare.That said I think PHPLaravel are a rocksolid choice for the samereasonsReplyLikeMore All Messages By This Member Report This MessageFrom: Nikhil Singh nikhiltektorch.com.auBCC MeReply to Author Preview Edit Discard Group ReplyDone Upload AttachmentsCancel AddDone Insert ImagesCancel Add",
         "summary":"Its really hard to do a ground up rewrite and not lose your sanity in the process. If youre stuck in one of these projects, read Dans blog post for some tips on how to survive."
      },
      {
         "UserName":"Michael Crabtree",
         "Date":"Apr 28",
         "Thread_id":"#5204",
         "content":"ErikThat is why I love Heimdalldata you really helped out our enterprisehealthcare client with the data proxy and I am convinced it will help most ofmy clients facing performance and security concerns with database connections.keep up the great workMichael Crabtree  CEO  NETSYNTROPYOutsmart ChaosSee our datasheet here: netsyntropy.come. Michael.crabtreenetsyntropy.com  m. 949.562.3612  o. 949.939.0689",
         "quoted":"",
         "summary":"Heimdalldata's data proxy helped our enterprise healthcare client with performance and security concerns around database connections."
      },
      {
         "UserName":"Jon Stockdill",
         "Date":"May 1",
         "Thread_id":"#5208",
         "content":"Bring the discussion back to the business outcomes KPIOKRs then the bigbang rebuild may not be the right decision.Often the most costly drag is inone or two features.More than likely the most costly drag is also the most complicated businesslogic that is also poorly defined both requirements and offering.ie junkin equals junk out.Rebuilding the application should also mean rebuildingthe offering.While rebuilding the offering the cost of rebuilding can bereduced.TLDR:Messy code comes from messy business.Clean up the business too ormake a more modern mess.jon he him his",
         "quoted":"On Thu Apr 28 2022 at 6:29 PM Michael Crabtreemichael.crabtreenetsyntropy.com wrote: Erik That is why I love Heimdalldata you really helped out our enterprise healthcare client with the data proxy and I am convinced it will help most of my clients facing performance and security concerns with database connections. keep up the great work Michael Crabtree  CEO  NETSYNTROPY Outsmart ChaosSee our datasheet here: netsyntropy.com e. Michael.crabtreenetsyntropy.com  m. 949.562.3612  o. 949.939.0689 ",
         "summary":"Rebuilding an application should also mean rebuilding the business logic that drives it. This will reduce the cost of rebuilding the application."
      },
      {
         "UserName":"Alan Blount",
         "Date":"May 1",
         "Thread_id":"#5210",
         "content":"I love that this is a super active thread and no surprise as we have allbeen faced with similar choices... and there are no foolproof methods ofestimating the project or executing it.As others have pointed out a lot ofit comes to state management and if old and new can coexist and impact tousers ideally minimal or zero.This is a 2004 book but its a great perspective on the problem if youre abook reader: Working Effectively with Legacy Code oreilly amazon.If you were to ask me to do this a lot depends on context I dont have but1st instinct tells me a strangler pattern is correct and Id probably proposesomething like this: Write a proxy in elixirphoenix and make that the new front end  a straight passthrough http proxy in a new application server languageframework Isolate segments  microservices  modules potentially on the old codebase first and then on the new Write new code in elixirphoenix Shadow traffic to both old and new log into a shadow DB or logs and ensure identical functionality Migrate segments  microservices  modules after proving they are functional Keep the old code in shadow mode in case of problems for a few months Wash rinse and repeatIf you felt like splitting off the front end and making the backendapplication stack API only that should either come before or after thislanguage migration....but it would certainly make this process easier asyoud only be mirroring API and business logic not also front end.Similarly if you want to change DB you may want to wait for anothermigration... or you could possibly keep the old and new DB in perfect syncwith lots of audits and alerts if not in sync select primarykeyfingerprintold.fieldfingerprintnew.field from old left join new usingprimarykeyIf you do ... well pretty much anything else ... you should probably think ofthis as a new application which may have a migration path from the old one...not a rewrite but a write.If the client wants to keep their application this is actually a greatinvestment.Right now its probably a bit toxic to work on it people arescared bugs are introduced to prod and nobody knows until clients complain...Its probably a mess.Your job is to ensure the client understands that it isprobably not sustainable in its current form... sooner or later they will haveto deal with this problem or freeze the app in its current state forever orwalk away.When the foundation of a house is untrustworthy all the paint orremodeling work you want to do is a waste until you face up to fixing thefoundation.Good luckYou can do it just be cautious especially about statereplication.Thanksalan",
         "quoted":"On Sun May 1 2022 at 6:09 AM Jon Stockdill jon.stockdillgmail.com wrote: Bring the discussion back to the business outcomes KPIOKRs then the big bang rebuild may not be the right decision.Often the most costly drag is in one or two features. More than likely the most costly drag is also the most complicated business logic that is also poorly defined both requirements and offering.ie junk in equals junk out.Rebuilding the application should also mean re building the offering.While rebuilding the offering the cost of rebuilding can be reduced. TLDR:Messy code comes from messy business.Clean up the business too or make a more modern mess. jon he him his On Thu Apr 28 2022 at 6:29 PM Michael Crabtree michael.crabtreenetsyntropy.com wrote: Erik That is why I love Heimdalldata you really helped out our enterprisehealthcare client with the data proxy and I am convinced it will help most ofmy clients facing performance and security concerns with database connections. keep up the great work Michael Crabtree  CEO  NETSYNTROPY Outsmart ChaosSee our datasheet here: netsyntropy.com e. Michael.crabtreenetsyntropy.com  m. 949.562.3612  o. 949.939.0689 ",
         "summary":"1. Write a proxy in elixir/phoenix and make that the new front end.\n\n2. Isolate segments (microservices, modules) potentially on the old codebase first and then on the new codebase.\n\n3. Write new code in elixir/phoenix.\n\n4. Shadow traffic to both old and new codebases, logging into a shadow DB or logs, and ensure identical functionality.\n\n5. Migrate segments (microservices, modules) after proving they are functional.\n\n6. Keep the old code in shadow mode in case of problems for a few months.\n\n7. Wash, rinse, and repeat."
      }
   ]
}